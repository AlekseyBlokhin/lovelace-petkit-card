function E(i){let t=Math.round(i||0);if(t<60)return`${t}s`;let e=Math.floor(t/60),n=t%60;return`${e}m${n.toString().padStart(2,"0")}s`}function O(i){let t=Math.round(i||0),e=Math.floor(t/60),n=t%60;return`${e.toString().padStart(2,"0")}'${n.toString().padStart(2,"0")}"`}function V(i){let t=Math.floor(i);return t<1?"under 1h":t<48?`${t}h`:`${Math.floor(t/24)}d`}function f(i){return String(i).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function A(i,t=new Date){let e=new Date(t.getFullYear(),t.getMonth(),t.getDate());e.setDate(e.getDate()+i);let n=new Date(e);return n.setDate(n.getDate()+1),{start:e,end:n}}function F(i,t=new Date){if(i===0)return"Today";if(i===-1)return"Yesterday";let{start:e}=A(i,t);return e.toLocaleDateString(void 0,{weekday:"short",month:"short",day:"numeric"})}function N(i){let t=new Date(i);return`${t.getFullYear()}-${t.getMonth()}-${t.getDate()}`}function T({startTime:i,endTime:t,entityIds:e,includeStartTimeState:n=!1}){let o=i instanceof Date?i.toISOString():i,a=t instanceof Date?t.toISOString():t;return{type:"history/history_during_period",start_time:o,end_time:a,entity_ids:e,minimal_response:!1,no_attributes:!0,include_start_time_state:n}}function wt(i){if(!i)return null;let t=i.s??i.state,e=parseFloat(t),n=i.lu?i.lu*1e3:i.last_changed?Date.parse(i.last_changed):null;return!Number.isFinite(e)||!n||Number.isNaN(n)?null:{value:e,ts:n}}function U(i,{minDelta:t=0,maxDelta:e=1/0}={}){if(!Array.isArray(i))return[];let n=i.map(wt).filter(Boolean).sort((a,s)=>a.ts-s.ts),o=[];for(let a=1;a<n.length;a++){let s=n[a].value-n[a-1].value;if(s<=t||s>=e)continue;let r=n[a+1];r&&r.value===n[a-1].value||o.push({value:s,ts:n[a].ts})}return o}var Ct="unknown_pet",w="Unknown";function z(i,t){if(!Array.isArray(i))return[];let e=new Set(t),n=[];for(let o of i){let a=o.s??o.state,s;if(e.has(a))s=a;else if(a===Ct)s=w;else continue;let r=o.lu?o.lu*1e3:o.last_changed?Date.parse(o.last_changed):null;!r||Number.isNaN(r)||n.push({cat:s,ts:r})}return n.sort((o,a)=>o.ts-a.ts),n}function W(i,t){let e=i.length,n=new Array(e).fill(null),o=0,a=null;for(let s=0;s<e;s++){let r=i[s].ts,c=s===0?-1/0:(i[s-1].ts+r)/2,u=s===e-1?1/0:(r+i[s+1].ts)/2;for(;o<t.length&&t[o].ts<c;)a=t[o].cat,o++;let h=null,d=1/0;for(;o<t.length&&t[o].ts<u;){let m=Math.abs(t[o].ts-r);m<d&&(d=m,h=t[o].cat),a=t[o].cat,o++}n[s]=h!==null?h:a}return i.map((s,r)=>({...s,cat:n[r]}))}var Et=[10,15,30,60,120,180,300,600,900,1800,3600];function P(i){for(let t of Et)if(i/t<=5)return t;return Math.ceil(i/5/60)*60}function j({dayStart:i,niceMax:t,width:e,height:n,padding:o}){let{left:a,right:s,top:r,bottom:c}=o,u=e-a-s,h=n-r-c,d=i.getTime();return{xFor:v=>{let $=(v-d)/36e5;return a+$/24*u},yFor:v=>t?n-c-v/t*h:n-c}}function q({niceMax:i,yStep:t,width:e,height:n,padding:o}){let{left:a,right:s,top:r,bottom:c}=o,u=e-a-s,h=n-r-c,d=[4,8,12,16,20].map(p=>({hour:p,x:a+p/24*u,label:`${p.toString().padStart(2,"0")}:00`})),m=[];if(t>0)for(let p=0;p<=i;p+=t){let v=i?n-c-p/i*h:n-c;m.push({value:p,y:v,label:O(p)})}return{vertical:d,horizontal:m}}function G(i,{dayKeyFn:t}){let e={};for(let n of i||[]){let o=t(n.ts);e[o]||(e[o]={count:0,total:0}),e[o].count+=1,e[o].total+=n.value}return e}function K(i,t){let e=Object.keys(i).filter(h=>h!==t).sort(),n=e.slice(-3),o=e.slice(-7),a=(h,d)=>h.length?h.reduce((m,p)=>m+i[p][d],0)/h.length:null,s=h=>{if(!h.length)return null;let d=h.reduce((p,v)=>p+i[v].total,0),m=h.reduce((p,v)=>p+i[v].count,0);return m>0?d/m:null},r=i[t],c=r?r.count:0,u=r?r.total:0;return{todayCount:c,todayTotal:u,todayAvgDuration:c>0?u/c:null,avg3dVisits:a(n,"count"),avg3dTotal:a(n,"total"),avg3dDuration:s(n),avg7dVisits:a(o,"count"),avg7dTotal:a(o,"total"),avg7dDuration:s(o),daysOfHistory:e.length}}function X({lastVisitTs:i,now:t,thresholdHours:e}){let n=t instanceof Date?t.getTime():t;if(i==null)return{alerting:!0,hoursSince:null};let o=(n-i)/36e5;return{alerting:o>=e,hoursSince:o}}function Y(i,t){let e=t;i.value_map&&t in i.value_map?e=i.value_map[t]:t!==null&&i.unit&&(e=`${t}${i.unit}`),e==null&&(e="\u2014");let n=parseFloat(t),o=!1;return i.warn_below!==void 0&&Number.isFinite(n)&&(o=n<i.warn_below),i.warn_above!==void 0&&Number.isFinite(n)&&(o=o||n>i.warn_above),i.warn_state!==void 0&&(o=o||t===i.warn_state),{display:e,warn:o}}function J(i,t,e){return!t||!i||!i.states||!i.states[t]?e:i.states[t].state}function Q(i,t){let e=new CustomEvent("hass-more-info",{bubbles:!0,composed:!0,detail:{entityId:t}});i.dispatchEvent(e)}function L(i,t,e,n){i.callService(t,e,n)}function k(i,t){t&&L(i,"button","press",{entity_id:t})}var Z=`
...
`;var tt={maintenance_mode:"Maintenance mode",manual_odor_completed:"Manual odor removal done",auto_cleaning_completed:"Auto cleaning done"},et=["unavailable","unknown","no_events_yet"],I="#9e9e9e",nt="PETKIT PURAMAX",ot=60,it=8,st=1800,at=600,rt=240,ct={left:46,right:10,top:10,bottom:28};var R=class extends HTMLElement{static getConfigElement(){return document.createElement("petkit-puramax-card-editor")}static getStubConfig(){return{type:"custom:petkit-puramax-card",title:"PETKIT PURAMAX",device_entities:{error:"sensor.example_petkit_error",last_event:"sensor.example_petkit_last_event",state:"sensor.example_petkit_state",total_use:"sensor.example_petkit_total_use"},cats:[{name:"Example Cat",color:"#4fc3f7"}]}}setConfig(t){if(!t)throw new Error("petkit-puramax-card: config is required");if(!t.device_entities)throw new Error('petkit-puramax-card: "device_entities" is required in config');if(!t.device_entities.total_use)throw new Error('petkit-puramax-card: "device_entities.total_use" is required in config');if(!t.cats)throw new Error('petkit-puramax-card: "cats" is required in config');if(!Array.isArray(t.cats)||t.cats.length<1)throw new Error('petkit-puramax-card: "cats" must be a non-empty array');if(t.cats.length>1&&!t.device_entities.last_used_by)throw new Error('petkit-puramax-card: "device_entities.last_used_by" is required in config when more than one cat is configured');t.cats.forEach((e,n)=>{if(!e||!e.name)throw new Error(`petkit-puramax-card: cats[${n}].name is required`);if(!e.color)throw new Error(`petkit-puramax-card: cats[${n}].color is required`)}),this._config=t,this._dayOffset=0,this._analytics=null,this._chartData=null,this._loadingChart=!1,this._loadingAnalytics=!1,this.shadowRoot||this.attachShadow({mode:"open"}),this._render()}set hass(t){let e=this._hass;if(this._hass=t,!this._built){this._built=!0,this._render(),this._loadDay(),this._loadAnalytics(),this._startNoVisitTimer();return}this._updateLiveValues(),this._maybeRefreshOnNewVisit(e)}get hass(){return this._hass}getCardSize(){return 14}connectedCallback(){this._hass&&!this._built&&(this._built=!0,this._render(),this._loadDay(),this._loadAnalytics(),this._startNoVisitTimer())}disconnectedCallback(){this._noVisitTimer&&(clearInterval(this._noVisitTimer),this._noVisitTimer=null)}_startNoVisitTimer(){this._noVisitTimer||(this._noVisitTimer=setInterval(()=>this._checkNoVisitAlerts(),300*1e3))}_maybeRefreshOnNewVisit(t){if(!t)return;let e=this._config.device_entities.total_use,n=t.states[e],o=this._hass.states[e];o&&(!n||n.last_changed!==o.last_changed)&&(this._dayOffset===0&&this._loadDay(),this._loadAnalytics())}_s(t,e){return J(this._hass,t,e)}async _fetchVisits({start:t,end:e}){let n=this._config,o=T({startTime:t,endTime:e,entityIds:[n.device_entities.total_use]}),a=[this._hass.callWS(o)];if(n.cats.length>1){let d=T({startTime:t,endTime:e,entityIds:[n.device_entities.last_used_by],includeStartTimeState:!0});a.push(this._hass.callWS(d))}let s={},r={};try{let[d,m]=await Promise.all(a);s=d||{},r=m||{}}catch{}let c=U(s[n.device_entities.total_use],{minDelta:0,maxDelta:st}),u;if(n.cats.length>1){let d=n.cats.map(p=>p.name),m=z(r[n.device_entities.last_used_by],d);u=W(c,m)}else u=c.map(d=>({...d,cat:n.cats[0].name}));let h=new Map(n.cats.map(d=>[d.name,d]));return u.map(d=>({cat:d.cat===w?this._unknownCat():h.get(d.cat)||null,duration:d.value,ts:d.ts}))}_unknownCat(){return{name:w,color:this._config.unknown_cat_color||I}}async _loadDay(){if(!this._hass)return;this._loadingChart=!0,this._renderChartArea();let t=this._config,{start:e,end:n}=A(this._dayOffset),o=[],a=[];try{let[s,r]=await Promise.all([this._fetchVisits({start:e,end:n}),t.device_entities.last_event?this._hass.callWS(T({startTime:e,endTime:n,entityIds:[t.device_entities.last_event]})):Promise.resolve({})]);o=s,a=(r||{})[t.device_entities.last_event]||[]}catch{o=[],a=[]}this._chartVisits=o,this._chartEventHist=a,this._loadingChart=!1,this._renderChartArea()}async _loadAnalytics(){if(!this._hass)return;this._loadingAnalytics=!0,this._renderAnalyticsArea();let t=this._config,e=new Date,n=new Date(e.getTime()-168*3600*1e3),o=[];try{o=await this._fetchVisits({start:n,end:e})}catch{o=[]}let a=N(e.getTime()),s={};t.cats.forEach(r=>{let c=o.filter(d=>d.cat===r).map(d=>({value:d.duration,ts:d.ts})),u=G(c,{dayKeyFn:N}),h=c.length?Math.max(...c.map(d=>d.ts)):null;s[r.name]={...K(u,a),lastVisitTs:h}}),this._analytics=s,this._loadingAnalytics=!1,this._checkNoVisitAlerts(),this._renderAnalyticsArea()}_checkNoVisitAlerts(){if(!this._analytics||!this._built)return;let t=this._config,e=t.no_visit_alert_hours??it,n=Date.now();this._notifiedCats||(this._notifiedCats=new Set),t.cats.forEach(o=>{let a=this._analytics[o.name];if(!a)return;let s=X({lastVisitTs:a.lastVisitTs,now:n,thresholdHours:e});a.noVisitAlert=s;let r=this._notifiedCats.has(o.name);s.alerting&&!r?(this._notifiedCats.add(o.name),this._sendNoVisitNotification(o,s)):!s.alerting&&r&&this._notifiedCats.delete(o.name)}),this._renderAnalyticsArea()}_sendNoVisitNotification(t,e){let n=this._config.notify_service;if(!n||!this._hass)return;let o=n.indexOf(".");if(o===-1)return;let a=n.slice(0,o),s=n.slice(o+1);if(a!=="notify"||!s)return;let r=e.hoursSince==null?`${t.name} hasn't used the litter box yet in the tracked history.`:`${t.name} hasn't used the litter box in over ${Math.floor(e.hoursSince)}h.`;L(this._hass,"notify",s,{message:r,title:"Litter box alert"})}_render(){let t=this._config;this.shadowRoot.innerHTML=`
    ...
    `,this.shadowRoot.getElementById("prev-day").addEventListener("click",()=>this._changeDay(-1)),this.shadowRoot.getElementById("next-day").addEventListener("click",()=>this._changeDay(1)),this._updateLiveValues(),this._renderChartArea(),this._renderAnalyticsArea()}_changeDay(t){this._dayOffset+=t,this._dayOffset>0&&(this._dayOffset=0),this._loadDay()}_updateLiveValues(){if(!this._built)return;let t=this._config,e=t.device_entities,n=this.shadowRoot.getElementById("status-row");if(n){let a=this._s(e.error,"no_error"),s=a&&a!=="no_error",r=t.info_row||[];n.innerHTML=[...r.map(c=>this._renderInfoChip(c)),s?this._chip("mdi:alert","Error",a.replace(/_/g," "),!0):""].join("")}let o=this.shadowRoot.getElementById("controls-row");if(o&&!o.dataset.bound){let a=t.controls_row||[];o.innerHTML=a.map((s,r)=>`
      <ha-control-button class="ctrl-btn" id="ctrl-${r}" label="${f(s.name||"")}">
        <div class="ctrl-btn-content">
          <ha-icon icon="${f(s.icon||"mdi:help")}"></ha-icon>
          <span>${f(s.name||"")}</span>
        </div>
      </ha-control-button>
    `).join(""),o.dataset.bound="1",a.forEach((s,r)=>{this.shadowRoot.getElementById(`ctrl-${r}`).addEventListener("click",()=>this._runControlAction(s))})}}_renderInfoChip(t){let e=this._s(t.entity,null),{display:n,warn:o}=Y(t,e);return this._chip(t.icon||"mdi:information-outline",t.name||t.entity,n,o)}_runControlAction(t){switch(t.action){case"press":{t.confirm?window.confirm(t.confirm)&&k(this._hass,t.entity):k(this._hass,t.entity);break}case"toggle_maintenance":{let e=t.state_entity||this._config.device_entities.state;this._s(e,"")==="maintenance"?k(this._hass,t.exit_entity):k(this._hass,t.start_entity);break}case"toggle":{L(this._hass,"homeassistant","toggle",{entity_id:t.entity});break}case"more_info":{Q(this,t.entity);break}default:break}}_chip(t,e,n,o){return`
      <div class="chip ${o?"warn":""}">
        <ha-icon icon="${f(t)}"></ha-icon>
        <div class="chip-text"><div class="chip-label">${f(e)}</div><div class="chip-value">${f(n)}</div></div>
      </div>`}_renderChartArea(){if(!this._built)return;let t=this.shadowRoot.getElementById("day-label");t&&(t.textContent=F(this._dayOffset));let e=this.shadowRoot.getElementById("next-day");e&&(e.disabled=this._dayOffset>=0);let n=this.shadowRoot.getElementById("chart-area"),o=this.shadowRoot.getElementById("records-list"),a=this.shadowRoot.getElementById("usage-body");if(!n||this._loadingChart)return;let s=this._config,r=(this._chartVisits||[]).filter(l=>l.cat).sort((l,_)=>l.ts-_.ts),c=at,u=rt,h=ct,d=Math.max(60,...r.map(l=>l.duration)),m=P(d),p=Math.ceil(d/m)*m,{start:v}=A(this._dayOffset),{xFor:$,yFor:lt}=j({dayStart:v,niceMax:p,width:c,height:u,padding:h}),{vertical:B,horizontal:M}=q({niceMax:p,yStep:m,width:c,height:u,padding:h}),dt=B.map(l=>`<line x1="${l.x}" y1="${h.top}" x2="${l.x}" y2="${u-h.bottom}" class="grid-line-v" />`).join(""),ht=M.map(l=>`<line x1="${h.left}" y1="${l.y}" x2="${c-h.right}" y2="${l.y}" class="grid-line-h" />`).join(""),ut=(u-h.bottom)/u*100,pt=B.map(l=>`<div class="axis-label" style="left:${l.x/c*100}%;top:${ut}%">${l.label}</div>`).join(""),mt=h.left/c*100,_t=M.map(l=>`<div class="axis-label-y" style="top:${l.y/u*100}%;width:${mt}%">${l.label}</div>`).join(""),ft=r.map((l,_)=>{let g=$(l.ts),y=lt(l.duration),x=u-h.bottom;return`<line x1="${g}" y1="${x}" x2="${g}" y2="${y}" stroke="${l.cat.color}" stroke-width="2" />
              <circle class="visit-point" cx="${g}" cy="${y}" r="5" fill="${l.cat.color}" />
              <line class="visit-hit" data-idx="${_}" x1="${g}" y1="${x}" x2="${g}" y2="${y}" stroke="transparent" stroke-width="16" />`}).join("");n.innerHTML=`
    ...
    `;let C=this.shadowRoot.getElementById("chart-tooltip"),gt=n.querySelector(".chart-wrap");if(n.querySelectorAll(".visit-hit").forEach(l=>{l.addEventListener("mouseenter",()=>{let _=r[parseInt(l.dataset.idx,10)],g=new Date(_.ts).toLocaleTimeString(void 0,{hour:"2-digit",minute:"2-digit"});C.textContent=`${g} \xB7 ${_.cat.name} \xB7 ${E(_.duration)}`;let y=l.getBoundingClientRect(),x=gt.getBoundingClientRect();C.style.left=`${y.left-x.left+y.width/2}px`,C.style.top=`${y.top-x.top}px`,C.classList.add("visible")}),l.addEventListener("mouseleave",()=>{C.classList.remove("visible")})}),a){let l={};s.cats.forEach(b=>{l[b.name]={count:0}});let _=0,g=I;r.forEach(b=>{b.cat.name===w?(_+=1,g=b.cat.color):l[b.cat.name].count+=1});let y=r.length,x=s.cats.map(b=>{let xt=l[b.name];return`<span class="usage-cat"><span class="dot" style="background:${b.color}"></span>${b.name}: ${xt.count}</span>`}).join("")+(_>0?`<span class="usage-cat"><span class="dot" style="background:${g}"></span>${w}: ${_}</span>`:"");a.innerHTML=`
        <div class="usage-row">
          <div class="stat-value">${y} time${y===1?"":"s"}</div>
          <div class="usage-cats">${x}</div>
        </div>
      `}let vt=this._chartEventHist||[],yt=this._eventLabels(),bt=(s.event_exclude||et).map(l=>String(l).toLowerCase()),D=vt.map(l=>{let _=l.s??l.state,g=l.lu?l.lu*1e3:l.last_changed?Date.parse(l.last_changed):null;return!_||!g||bt.includes(_.toLowerCase())?null:{ts:g,icon:"mdi:information-outline",color:"var(--secondary-text-color)",text:yt[_]||_}}).filter(Boolean);D.sort((l,_)=>_.ts-l.ts),o&&(D.length===0?o.innerHTML='<div class="empty-note">No records for this day</div>':o.innerHTML=D.map(l=>`
          <div class="record-row">
            <div class="record-time">${new Date(l.ts).toLocaleTimeString(void 0,{hour:"2-digit",minute:"2-digit"})}</div>
            <ha-icon icon="${f(l.icon)}" style="color:${f(l.color)}"></ha-icon>
            <div class="record-text">${f(l.text)}</div>
          </div>
        `).join(""))}_eventLabels(){return{...tt,...this._config.event_labels||{}}}_renderAnalyticsArea(){if(!this._built)return;let t=this.shadowRoot.getElementById("analytics-grid"),e=this.shadowRoot.getElementById("decline-banner"),n=this.shadowRoot.getElementById("no-visit-banner");if(!t||this._loadingAnalytics||!this._analytics)return;let o=this._config,a=(o.decline_threshold_pct||ot)/100,s=[];if(t.innerHTML=o.cats.map(r=>{let c=this._analytics[r.name]||{};return c.daysOfHistory>=3&&c.avg7dTotal&&new Date().getHours()>=18&&(c.todayTotal<a*c.avg7dTotal?s.push(`${r.name}'s usage today is well below their recent average \u2014 worth a check.`):c.todayTotal>(2-a)*c.avg7dTotal&&s.push(`${r.name}'s usage today is well above their recent average \u2014 worth a check.`)),`
        <div class="cat-analytics">
          <table>
            <colgroup>
              <col class="col-name" /><col class="col-stat" /><col class="col-stat" /><col class="col-stat" />
            </colgroup>
            <tr><td class="cat-name-cell"><span class="dot" style="background:${f(r.color)}"></span>${f(r.name)}</td><td>Today</td><td>3d avg</td><td>7d avg</td></tr>
    ...
    `,this._renderMainForm(),this._renderCats(),this._renderInfoRows(),this._renderControlsRows(),this.shadowRoot.getElementById("add-cat").addEventListener("click",()=>this._addCat()),this.shadowRoot.getElementById("add-info-row").addEventListener("click",()=>this._addInfoRow()),this.shadowRoot.getElementById("add-control-row").addEventListener("click",()=>this._addControlRow())}_removeIconButton(t){let e=document.createElement("ha-icon-button");e.className="remove-btn",e.label="Remove";let n=document.createElement("ha-icon");return n.setAttribute("icon","mdi:delete-outline"),e.appendChild(n),e.addEventListener("click",t),e}_renderCats(){let t=this.shadowRoot.getElementById("cats-rows");t.innerHTML="",(this._config.cats||[]).forEach((n,o)=>{let a=document.createElement("div");a.className="row",a.dataset.index=String(o);let s=document.createElement("ha-form");s.schema=kt,s.data=n,s.hass=this._hass,s.computeLabel=r=>r.label||r.name,s.addEventListener("value-changed",r=>{r.stopPropagation(),this._updateCat(o,r.detail.value)}),this._formEls.push(s),a.appendChild(s),a.appendChild(this._removeIconButton(()=>this._removeCat(o))),t.appendChild(a)})}_updateCat(t,e){let n=[...this._config.cats||[]];n[t]=e,this._fireConfigChanged({...this._config,cats:n})}_addCat(){let t=[...this._config.cats||[],{...At}];this._fireConfigChanged({...this._config,cats:t}),this._render()}_removeCat(t){let e=(this._config.cats||[]).filter((n,o)=>o!==t);this._fireConfigChanged({...this._config,cats:e}),this._render()}_renderInfoRows(){let t=this.shadowRoot.getElementById("info-rows");t.innerHTML="",(this._config.info_row||[]).forEach((n,o)=>{let a=document.createElement("div");a.className="row",a.dataset.index=String(o);let s=document.createElement("ha-form");s.schema=Tt,s.data=n,s.hass=this._hass,s.computeLabel=r=>r.label||r.name,s.addEventListener("value-changed",r=>{r.stopPropagation(),this._updateInfoRow(o,r.detail.value)}),this._formEls.push(s),a.appendChild(s),a.appendChild(this._removeIconButton(()=>this._removeInfoRow(o))),t.appendChild(a)})}_updateInfoRow(t,e){let n=[...this._config.info_row||[]];n[t]=e,this._fireConfigChanged({...this._config,info_row:n})}_addInfoRow(){let t=[...this._config.info_row||[],{...Lt}];this._fireConfigChanged({...this._config,info_row:t}),this._render()}_removeInfoRow(t){let e=(this._config.info_row||[]).filter((n,o)=>o!==t);this._fireConfigChanged({...this._config,info_row:e}),this._render()}_renderControlsRows(){let t=this.shadowRoot.getElementById("controls-rows");t.innerHTML="",(this._config.controls_row||[]).forEach((n,o)=>{let a=document.createElement("div");a.className="row",a.dataset.index=String(o);let s=document.createElement("ha-form");s.schema=Dt(n.action),s.data=n,s.hass=this._hass,s.computeLabel=r=>r.label||r.name,s.addEventListener("value-changed",r=>{r.stopPropagation(),this._updateControlRow(o,r.detail.value)}),this._formEls.push(s),a.appendChild(s),a.appendChild(this._removeIconButton(()=>this._removeControlRow(o))),t.appendChild(a)})}_updateControlRow(t,e){let n=[...this._config.controls_row||[]],o=n[t]&&n[t].action;n[t]=e,this._fireConfigChanged({...this._config,controls_row:n}),e.action!==o&&this._renderControlsRows()}_addControlRow(){let t=[...this._config.controls_row||[],{...Nt}];this._fireConfigChanged({...this._config,controls_row:t}),this._render()}_removeControlRow(t){let e=(this._config.controls_row||[]).filter((n,o)=>o!==t);this._fireConfigChanged({...this._config,controls_row:e}),this._render()}_renderMainForm(){let t=this.shadowRoot.getElementById("main-section"),e=document.createElement("ha-form");e.schema=It,e.data=this._flattenMain(),e.hass=this._hass,e.computeLabel=n=>n.label||n.name,e.addEventListener("value-changed",n=>{n.stopPropagation(),this._onMainFormChanged(n.detail.value)}),this._formEls.push(e),t.appendChild(e)}};customElements.get("petkit-puramax-card")||customElements.define("petkit-puramax-card",R);customElements.get("petkit-puramax-card-editor")||customElements.define("petkit-puramax-card-editor",S);var H=window;H.customCards=H.customCards||[];H.customCards.push({type:"petkit-puramax-card",name:"PETKIT PURAMAX Card",description:"Configurable card for PETKIT PURAMAX litter box monitoring, controls, and per-cat visit analytics."});
