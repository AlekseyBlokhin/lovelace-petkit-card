var W2=Object.defineProperty;var I2=(M,C,H)=>C in M?W2(M,C,{enumerable:!0,configurable:!0,writable:!0,value:H}):M[C]=H;var B=(M,C,H)=>I2(M,typeof C!="symbol"?C+"":C,H);var Y=globalThis,J=Y.ShadowRoot&&(Y.ShadyCSS===void 0||Y.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,x1=Symbol(),T1=new WeakMap,N=class{constructor(C,H,V){if(this._$cssResult$=!0,V!==x1)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=C,this.t=H}get styleSheet(){let C=this.o,H=this.t;if(J&&C===void 0){let V=H!==void 0&&H.length===1;V&&(C=T1.get(H)),C===void 0&&((this.o=C=new CSSStyleSheet).replaceSync(this.cssText),V&&T1.set(H,C))}return C}toString(){return this.cssText}},F1=M=>new N(typeof M=="string"?M:M+"",void 0,x1),$=(M,...C)=>{let H=M.length===1?M[0]:C.reduce((V,L,r)=>V+(e=>{if(e._$cssResult$===!0)return e.cssText;if(typeof e=="number")return e;throw Error("Value passed to 'css' function must be a 'css' function result: "+e+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(L)+M[r+1],M[0]);return new N(H,M,x1)},R1=(M,C)=>{if(J)M.adoptedStyleSheets=C.map(H=>H instanceof CSSStyleSheet?H:H.styleSheet);else for(let H of C){let V=document.createElement("style"),L=Y.litNonce;L!==void 0&&V.setAttribute("nonce",L),V.textContent=H.cssText,M.appendChild(V)}},Z1=J?M=>M:M=>M instanceof CSSStyleSheet?(C=>{let H="";for(let V of C.cssRules)H+=V.cssText;return F1(H)})(M):M;var{is:U2,defineProperty:G2,getOwnPropertyDescriptor:Q2,getOwnPropertyNames:z2,getOwnPropertySymbols:K2,getPrototypeOf:q2}=Object,c=globalThis,_1=c.trustedTypes,j2=_1?_1.emptyScript:"",X2=c.reactiveElementPolyfillSupport,W=(M,C)=>M,s1={toAttribute(M,C){switch(C){case Boolean:M=M?j2:null;break;case Object:case Array:M=M==null?M:JSON.stringify(M)}return M},fromAttribute(M,C){let H=M;switch(C){case Boolean:H=M!==null;break;case Number:H=M===null?null:Number(M);break;case Object:case Array:try{H=JSON.parse(M)}catch{H=null}}return H}},E1=(M,C)=>!U2(M,C),D1={attribute:!0,type:String,converter:s1,reflect:!1,useDefault:!1,hasChanged:E1};Symbol.metadata??(Symbol.metadata=Symbol("metadata")),c.litPropertyMetadata??(c.litPropertyMetadata=new WeakMap);var Z=class extends HTMLElement{static addInitializer(C){this._$Ei(),(this.l??(this.l=[])).push(C)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(C,H=D1){if(H.state&&(H.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(C)&&((H=Object.create(H)).wrapped=!0),this.elementProperties.set(C,H),!H.noAccessor){let V=Symbol(),L=this.getPropertyDescriptor(C,V,H);L!==void 0&&G2(this.prototype,C,L)}}static getPropertyDescriptor(C,H,V){let{get:L,set:r}=Q2(this.prototype,C)??{get(){return this[H]},set(e){this[H]=e}};return{get:L,set(e){let t=L?.call(this);r?.call(this,e),this.requestUpdate(C,t,V)},configurable:!0,enumerable:!0}}static getPropertyOptions(C){return this.elementProperties.get(C)??D1}static _$Ei(){if(this.hasOwnProperty(W("elementProperties")))return;let C=q2(this);C.finalize(),C.l!==void 0&&(this.l=[...C.l]),this.elementProperties=new Map(C.elementProperties)}static finalize(){if(this.hasOwnProperty(W("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(W("properties"))){let H=this.properties,V=[...z2(H),...K2(H)];for(let L of V)this.createProperty(L,H[L])}let C=this[Symbol.metadata];if(C!==null){let H=litPropertyMetadata.get(C);if(H!==void 0)for(let[V,L]of H)this.elementProperties.set(V,L)}this._$Eh=new Map;for(let[H,V]of this.elementProperties){let L=this._$Eu(H,V);L!==void 0&&this._$Eh.set(L,H)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(C){let H=[];if(Array.isArray(C)){let V=new Set(C.flat(1/0).reverse());for(let L of V)H.unshift(Z1(L))}else C!==void 0&&H.push(Z1(C));return H}static _$Eu(C,H){let V=H.attribute;return V===!1?void 0:typeof V=="string"?V:typeof C=="string"?C.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise(C=>this.enableUpdating=C),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach(C=>C(this))}addController(C){(this._$EO??(this._$EO=new Set)).add(C),this.renderRoot!==void 0&&this.isConnected&&C.hostConnected?.()}removeController(C){this._$EO?.delete(C)}_$E_(){let C=new Map,H=this.constructor.elementProperties;for(let V of H.keys())this.hasOwnProperty(V)&&(C.set(V,this[V]),delete this[V]);C.size>0&&(this._$Ep=C)}createRenderRoot(){let C=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return R1(C,this.constructor.elementStyles),C}connectedCallback(){this.renderRoot??(this.renderRoot=this.createRenderRoot()),this.enableUpdating(!0),this._$EO?.forEach(C=>C.hostConnected?.())}enableUpdating(C){}disconnectedCallback(){this._$EO?.forEach(C=>C.hostDisconnected?.())}attributeChangedCallback(C,H,V){this._$AK(C,V)}_$ET(C,H){let V=this.constructor.elementProperties.get(C),L=this.constructor._$Eu(C,V);if(L!==void 0&&V.reflect===!0){let r=(V.converter?.toAttribute!==void 0?V.converter:s1).toAttribute(H,V.type);this._$Em=C,r==null?this.removeAttribute(L):this.setAttribute(L,r),this._$Em=null}}_$AK(C,H){let V=this.constructor,L=V._$Eh.get(C);if(L!==void 0&&this._$Em!==L){let r=V.getPropertyOptions(L),e=typeof r.converter=="function"?{fromAttribute:r.converter}:r.converter?.fromAttribute!==void 0?r.converter:s1;this._$Em=L;let t=e.fromAttribute(H,r.type);this[L]=t??this._$Ej?.get(L)??t,this._$Em=null}}requestUpdate(C,H,V,L=!1,r){if(C!==void 0){let e=this.constructor;if(L===!1&&(r=this[C]),V??(V=e.getPropertyOptions(C)),!((V.hasChanged??E1)(r,H)||V.useDefault&&V.reflect&&r===this._$Ej?.get(C)&&!this.hasAttribute(e._$Eu(C,V))))return;this.C(C,H,V)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(C,H,{useDefault:V,reflect:L,wrapped:r},e){V&&!(this._$Ej??(this._$Ej=new Map)).has(C)&&(this._$Ej.set(C,e??H??this[C]),r!==!0||e!==void 0)||(this._$AL.has(C)||(this.hasUpdated||V||(H=void 0),this._$AL.set(C,H)),L===!0&&this._$Em!==C&&(this._$Eq??(this._$Eq=new Set)).add(C))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(H){Promise.reject(H)}let C=this.scheduleUpdate();return C!=null&&await C,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??(this.renderRoot=this.createRenderRoot()),this._$Ep){for(let[L,r]of this._$Ep)this[L]=r;this._$Ep=void 0}let V=this.constructor.elementProperties;if(V.size>0)for(let[L,r]of V){let{wrapped:e}=r,t=this[L];e!==!0||this._$AL.has(L)||t===void 0||this.C(L,void 0,r,t)}}let C=!1,H=this._$AL;try{C=this.shouldUpdate(H),C?(this.willUpdate(H),this._$EO?.forEach(V=>V.hostUpdate?.()),this.update(H)):this._$EM()}catch(V){throw C=!1,this._$EM(),V}C&&this._$AE(H)}willUpdate(C){}_$AE(C){this._$EO?.forEach(H=>H.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(C)),this.updated(C)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(C){return!0}update(C){this._$Eq&&(this._$Eq=this._$Eq.forEach(H=>this._$ET(H,this[H]))),this._$EM()}updated(C){}firstUpdated(C){}};Z.elementStyles=[],Z.shadowRootOptions={mode:"open"},Z[W("elementProperties")]=new Map,Z[W("finalized")]=new Map,X2?.({ReactiveElement:Z}),(c.reactiveElementVersions??(c.reactiveElementVersions=[])).push("2.1.2");var U=globalThis,N1=M=>M,C1=U.trustedTypes,$1=C1?C1.createPolicy("lit-html",{createHTML:M=>M}):void 0,u1="$lit$",s=`lit$${Math.random().toFixed(9).slice(2)}$`,c1="?"+s,Y2=`<${c1}>`,k=document,G=()=>k.createComment(""),Q=M=>M===null||typeof M!="object"&&typeof M!="function",h1=Array.isArray,z1=M=>h1(M)||typeof M?.[Symbol.iterator]=="function",S1=`[ 	
\f\r]`,I=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,W1=/-->/g,I1=/>/g,f=RegExp(`>|${S1}(?:([^\\s"'>=/]+)(${S1}*=${S1}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),U1=/'/g,G1=/"/g,K1=/^(?:script|style|textarea|title)$/i,O1=M=>(C,...H)=>({_$litType$:M,strings:C,values:H}),m=O1(1),e1=O1(2),_5=O1(3),S=Symbol.for("lit-noChange"),n=Symbol.for("lit-nothing"),Q1=new WeakMap,g=k.createTreeWalker(k,129);function q1(M,C){if(!h1(M)||!M.hasOwnProperty("raw"))throw Error("invalid template strings array");return $1!==void 0?$1.createHTML(C):C}var j1=(M,C)=>{let H=M.length-1,V=[],L,r=C===2?"<svg>":C===3?"<math>":"",e=I;for(let t=0;t<H;t++){let i=M[t],a,p,o=-1,A=0;for(;A<i.length&&(e.lastIndex=A,p=e.exec(i),p!==null);)A=e.lastIndex,e===I?p[1]==="!--"?e=W1:p[1]!==void 0?e=I1:p[2]!==void 0?(K1.test(p[2])&&(L=RegExp("</"+p[2],"g")),e=f):p[3]!==void 0&&(e=f):e===f?p[0]===">"?(e=L??I,o=-1):p[1]===void 0?o=-2:(o=e.lastIndex-p[2].length,a=p[1],e=p[3]===void 0?f:p[3]==='"'?G1:U1):e===G1||e===U1?e=f:e===W1||e===I1?e=I:(e=f,L=void 0);let d=e===f&&M[t+1].startsWith("/>")?" ":"";r+=e===I?i+Y2:o>=0?(V.push(a),i.slice(0,o)+u1+i.slice(o)+s+d):i+s+(o===-2?t:d)}return[q1(M,r+(M[H]||"<?>")+(C===2?"</svg>":C===3?"</math>":"")),V]},z=class M{constructor({strings:C,_$litType$:H},V){let L;this.parts=[];let r=0,e=0,t=C.length-1,i=this.parts,[a,p]=j1(C,H);if(this.el=M.createElement(a,V),g.currentNode=this.el.content,H===2||H===3){let o=this.el.content.firstChild;o.replaceWith(...o.childNodes)}for(;(L=g.nextNode())!==null&&i.length<t;){if(L.nodeType===1){if(L.hasAttributes())for(let o of L.getAttributeNames())if(o.endsWith(u1)){let A=p[e++],d=L.getAttribute(o).split(s),l=/([.?@])?(.*)/.exec(A);i.push({type:1,index:r,name:l[2],strings:d,ctor:l[1]==="."?V1:l[1]==="?"?L1:l[1]==="@"?M1:w}),L.removeAttribute(o)}else o.startsWith(s)&&(i.push({type:6,index:r}),L.removeAttribute(o));if(K1.test(L.tagName)){let o=L.textContent.split(s),A=o.length-1;if(A>0){L.textContent=C1?C1.emptyScript:"";for(let d=0;d<A;d++)L.append(o[d],G()),g.nextNode(),i.push({type:2,index:++r});L.append(o[A],G())}}}else if(L.nodeType===8)if(L.data===c1)i.push({type:2,index:r});else{let o=-1;for(;(o=L.data.indexOf(s,o+1))!==-1;)i.push({type:7,index:r}),o+=s.length-1}r++}}static createElement(C,H){let V=k.createElement("template");return V.innerHTML=C,V}};function y(M,C,H=M,V){if(C===S)return C;let L=V!==void 0?H._$Co?.[V]:H._$Cl,r=Q(C)?void 0:C._$litDirective$;return L?.constructor!==r&&(L?._$AO?.(!1),r===void 0?L=void 0:(L=new r(M),L._$AT(M,H,V)),V!==void 0?(H._$Co??(H._$Co=[]))[V]=L:H._$Cl=L),L!==void 0&&(C=y(M,L._$AS(M,C.values),L,V)),C}var H1=class{constructor(C,H){this._$AV=[],this._$AN=void 0,this._$AD=C,this._$AM=H}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(C){let{el:{content:H},parts:V}=this._$AD,L=(C?.creationScope??k).importNode(H,!0);g.currentNode=L;let r=g.nextNode(),e=0,t=0,i=V[0];for(;i!==void 0;){if(e===i.index){let a;i.type===2?a=new P(r,r.nextSibling,this,C):i.type===1?a=new i.ctor(r,i.name,i.strings,this,C):i.type===6&&(a=new r1(r,this,C)),this._$AV.push(a),i=V[++t]}e!==i?.index&&(r=g.nextNode(),e++)}return g.currentNode=k,L}p(C){let H=0;for(let V of this._$AV)V!==void 0&&(V.strings!==void 0?(V._$AI(C,V,H),H+=V.strings.length-2):V._$AI(C[H])),H++}},P=class M{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(C,H,V,L){this.type=2,this._$AH=n,this._$AN=void 0,this._$AA=C,this._$AB=H,this._$AM=V,this.options=L,this._$Cv=L?.isConnected??!0}get parentNode(){let C=this._$AA.parentNode,H=this._$AM;return H!==void 0&&C?.nodeType===11&&(C=H.parentNode),C}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(C,H=this){C=y(this,C,H),Q(C)?C===n||C==null||C===""?(this._$AH!==n&&this._$AR(),this._$AH=n):C!==this._$AH&&C!==S&&this._(C):C._$litType$!==void 0?this.$(C):C.nodeType!==void 0?this.T(C):z1(C)?this.k(C):this._(C)}O(C){return this._$AA.parentNode.insertBefore(C,this._$AB)}T(C){this._$AH!==C&&(this._$AR(),this._$AH=this.O(C))}_(C){this._$AH!==n&&Q(this._$AH)?this._$AA.nextSibling.data=C:this.T(k.createTextNode(C)),this._$AH=C}$(C){let{values:H,_$litType$:V}=C,L=typeof V=="number"?this._$AC(C):(V.el===void 0&&(V.el=z.createElement(q1(V.h,V.h[0]),this.options)),V);if(this._$AH?._$AD===L)this._$AH.p(H);else{let r=new H1(L,this),e=r.u(this.options);r.p(H),this.T(e),this._$AH=r}}_$AC(C){let H=Q1.get(C.strings);return H===void 0&&Q1.set(C.strings,H=new z(C)),H}k(C){h1(this._$AH)||(this._$AH=[],this._$AR());let H=this._$AH,V,L=0;for(let r of C)L===H.length?H.push(V=new M(this.O(G()),this.O(G()),this,this.options)):V=H[L],V._$AI(r),L++;L<H.length&&(this._$AR(V&&V._$AB.nextSibling,L),H.length=L)}_$AR(C=this._$AA.nextSibling,H){for(this._$AP?.(!1,!0,H);C!==this._$AB;){let V=N1(C).nextSibling;N1(C).remove(),C=V}}setConnected(C){this._$AM===void 0&&(this._$Cv=C,this._$AP?.(C))}},w=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(C,H,V,L,r){this.type=1,this._$AH=n,this._$AN=void 0,this.element=C,this.name=H,this._$AM=L,this.options=r,V.length>2||V[0]!==""||V[1]!==""?(this._$AH=Array(V.length-1).fill(new String),this.strings=V):this._$AH=n}_$AI(C,H=this,V,L){let r=this.strings,e=!1;if(r===void 0)C=y(this,C,H,0),e=!Q(C)||C!==this._$AH&&C!==S,e&&(this._$AH=C);else{let t=C,i,a;for(C=r[0],i=0;i<r.length-1;i++)a=y(this,t[V+i],H,i),a===S&&(a=this._$AH[i]),e||(e=!Q(a)||a!==this._$AH[i]),a===n?C=n:C!==n&&(C+=(a??"")+r[i+1]),this._$AH[i]=a}e&&!L&&this.j(C)}j(C){C===n?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,C??"")}},V1=class extends w{constructor(){super(...arguments),this.type=3}j(C){this.element[this.name]=C===n?void 0:C}},L1=class extends w{constructor(){super(...arguments),this.type=4}j(C){this.element.toggleAttribute(this.name,!!C&&C!==n)}},M1=class extends w{constructor(C,H,V,L,r){super(C,H,V,L,r),this.type=5}_$AI(C,H=this){if((C=y(this,C,H,0)??n)===S)return;let V=this._$AH,L=C===n&&V!==n||C.capture!==V.capture||C.once!==V.once||C.passive!==V.passive,r=C!==n&&(V===n||L);L&&this.element.removeEventListener(this.name,this,V),r&&this.element.addEventListener(this.name,this,C),this._$AH=C}handleEvent(C){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,C):this._$AH.handleEvent(C)}},r1=class{constructor(C,H,V){this.element=C,this.type=6,this._$AN=void 0,this._$AM=H,this.options=V}get _$AU(){return this._$AM._$AU}_$AI(C){y(this,C)}},X1={M:u1,P:s,A:c1,C:1,L:j1,R:H1,D:z1,V:y,I:P,H:w,N:L1,U:M1,B:V1,F:r1},J2=U.litHtmlPolyfillSupport;J2?.(z,P),(U.litHtmlVersions??(U.litHtmlVersions=[])).push("3.3.3");var Y1=(M,C,H)=>{let V=H?.renderBefore??C,L=V._$litPart$;if(L===void 0){let r=H?.renderBefore??null;V._$litPart$=L=new P(C.insertBefore(G(),r),r,void 0,H??{})}return L._$AI(M),L};var K=globalThis,x=class extends Z{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var H;let C=super.createRenderRoot();return(H=this.renderOptions).renderBefore??(H.renderBefore=C.firstChild),C}update(C){let H=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(C),this._$Do=Y1(H,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return S}};x._$litElement$=!0,x.finalized=!0,K.litElementHydrateSupport?.({LitElement:x});var C5=K.litElementPolyfillSupport;C5?.({LitElement:x});(K.litElementVersions??(K.litElementVersions=[])).push("4.2.2");var J1={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},C2=M=>(...C)=>({_$litDirective$:M,values:C}),t1=class{constructor(C){}get _$AU(){return this._$AM._$AU}_$AT(C,H,V){this._$Ct=C,this._$AM=H,this._$Ci=V}_$AS(C,H){return this.update(C,H)}update(C,H){return this.render(...H)}};var{I:H5}=X1,H2=M=>M;var V2=()=>document.createComment(""),T=(M,C,H)=>{let V=M._$AA.parentNode,L=C===void 0?M._$AB:C._$AA;if(H===void 0){let r=V.insertBefore(V2(),L),e=V.insertBefore(V2(),L);H=new H5(r,e,M,M.options)}else{let r=H._$AB.nextSibling,e=H._$AM,t=e!==M;if(t){let i;H._$AQ?.(M),H._$AM=M,H._$AP!==void 0&&(i=M._$AU)!==e._$AU&&H._$AP(i)}if(r!==L||t){let i=H._$AA;for(;i!==r;){let a=H2(i).nextSibling;H2(V).insertBefore(i,L),i=a}}}return H},h=(M,C,H=M)=>(M._$AI(C,H),M),V5={},L2=(M,C=V5)=>M._$AH=C,M2=M=>M._$AH,i1=M=>{M._$AR(),M._$AA.remove()};var r2=(M,C,H)=>{let V=new Map;for(let L=C;L<=H;L++)V.set(M[L],L);return V},e2=C2(class extends t1{constructor(M){if(super(M),M.type!==J1.CHILD)throw Error("repeat() can only be used in text expressions")}dt(M,C,H){let V;H===void 0?H=C:C!==void 0&&(V=C);let L=[],r=[],e=0;for(let t of M)L[e]=V?V(t,e):e,r[e]=H(t,e),e++;return{values:r,keys:L}}render(M,C,H){return this.dt(M,C,H).values}update(M,[C,H,V]){let L=M2(M),{values:r,keys:e}=this.dt(C,H,V);if(!Array.isArray(L))return this.ut=e,r;let t=this.ut??(this.ut=[]),i=[],a,p,o=0,A=L.length-1,d=0,l=r.length-1;for(;o<=A&&d<=l;)if(L[o]===null)o++;else if(L[A]===null)A--;else if(t[o]===e[d])i[d]=h(L[o],r[d]),o++,d++;else if(t[A]===e[l])i[l]=h(L[A],r[l]),A--,l--;else if(t[o]===e[l])i[l]=h(L[o],r[l]),T(M,i[l+1],L[o]),o++,l--;else if(t[A]===e[d])i[d]=h(L[A],r[d]),T(M,L[o],L[A]),A--,d++;else if(a===void 0&&(a=r2(e,d,l),p=r2(t,o,A)),a.has(t[o]))if(a.has(t[A])){let v=p.get(e[d]),E=v!==void 0?L[v]:null;if(E===null){let u=T(M,L[o]);h(u,r[d]),i[d]=u}else i[d]=h(E,r[d]),T(M,L[o],E),L[v]=null;d++}else i1(L[A]),A--;else i1(L[o]),o++;for(;d<=l;){let v=T(M,i[l+1]);h(v,r[d]),i[d++]=v}for(;o<=A;){let v=L[o++];v!==null&&i1(v)}return this.ut=e,L2(M,i),S}});function q(M){let C=Math.round(M||0);if(C<60)return`${C}s`;let H=Math.floor(C/60),V=C%60;return`${H}m${V.toString().padStart(2,"0")}s`}function t2(M){let C=Math.round(M||0),H=Math.floor(C/60),V=C%60;return`${H.toString().padStart(2,"0")}'${V.toString().padStart(2,"0")}"`}function i2(M){let C=Math.floor(M);return C<1?"under 1h":C<48?`${C}h`:`${Math.floor(C/24)}d`}function o1(M,C=new Date){let H=new Date(C.getFullYear(),C.getMonth(),C.getDate());H.setDate(H.getDate()+M);let V=new Date(H);return V.setDate(V.getDate()+1),{start:H,end:V}}function o2(M,C=new Date){if(M===0)return"Today";if(M===-1)return"Yesterday";let{start:H}=o1(M,C);return H.toLocaleDateString(void 0,{weekday:"short",month:"short",day:"numeric"})}function f1(M){let C=new Date(M);return`${C.getFullYear()}-${C.getMonth()}-${C.getDate()}`}function A1({startTime:M,endTime:C,entityIds:H,includeStartTimeState:V=!1}){let L=M instanceof Date?M.toISOString():M,r=C instanceof Date?C.toISOString():C;return{type:"history/history_during_period",start_time:L,end_time:r,entity_ids:H,minimal_response:!1,no_attributes:!0,include_start_time_state:V}}function a1(M){if(!M)return null;let C=M.s??M.state,H=M.lu?M.lu*1e3:M.last_changed?Date.parse(M.last_changed):null;return{state:C,ts:H}}function L5(M){let C=a1(M);if(!C)return null;let H=parseFloat(C.state),{ts:V}=C;return!Number.isFinite(H)||!V||Number.isNaN(V)?null:{value:H,ts:V}}function A2(M,{minDelta:C=0,maxDelta:H=1/0}={}){if(!Array.isArray(M))return[];let V=M.map(L5).filter(Boolean).sort((r,e)=>r.ts-e.ts),L=[];for(let r=1;r<V.length;r++){let e=V[r].value-V[r-1].value;if(e<=C||e>=H)continue;let t=V[r+1];t&&t.value===V[r-1].value||L.push({value:e,ts:V[r].ts})}return L}var M5="unknown_pet",F="Unknown";function a2(M,C){if(!Array.isArray(M))return[];let H=new Set(C),V=[];for(let L of M){let{state:r,ts:e}=a1(L),t;if(H.has(r))t=r;else if(r===M5)t=F;else continue;!e||Number.isNaN(e)||V.push({cat:t,ts:e})}return V.sort((L,r)=>L.ts-r.ts),V}function d2(M,C){let H=M.length,V=new Array(H).fill(null),L=0,r=null;for(let e=0;e<H;e++){let t=M[e].ts,i=e===0?-1/0:(M[e-1].ts+t)/2,a=e===H-1?1/0:(t+M[e+1].ts)/2;for(;L<C.length&&C[L].ts<i;)r=C[L].cat,L++;let p=null,o=1/0;for(;L<C.length&&C[L].ts<a;){let A=Math.abs(C[L].ts-t);A<o&&(o=A,p=C[L].cat),r=C[L].cat,L++}V[e]=p!==null?p:r}return M.map((e,t)=>({...e,cat:V[t]}))}var r5=[10,15,30,60,120,180,300,600,900,1800,3600];function p2(M){for(let C of r5)if(M/C<=5)return C;return Math.ceil(M/5/60)*60}function m2({dayStart:M,niceMax:C,width:H,height:V,padding:L}){let{left:r,right:e,top:t,bottom:i}=L,a=H-r-e,p=V-t-i,o=M.getTime();return{xFor:l=>{let v=(l-o)/36e5;return r+v/24*a},yFor:l=>C?V-i-l/C*p:V-i}}function n2({niceMax:M,yStep:C,width:H,height:V,padding:L}){let{left:r,right:e,top:t,bottom:i}=L,a=H-r-e,p=V-t-i,o=[4,8,12,16,20].map(d=>({hour:d,x:r+d/24*a,label:`${d.toString().padStart(2,"0")}:00`})),A=[];if(C>0)for(let d=0;d<=M;d+=C){let l=M?V-i-d/M*p:V-i;A.push({value:d,y:l,label:t2(d)})}return{vertical:o,horizontal:A}}function g1(M,C){let H={};return(M||[]).forEach(V=>{H[V.name]=C(V)}),H}function l2(M,{dayKeyFn:C}){let H={};for(let V of M||[]){let L=C(V.ts);H[L]||(H[L]={count:0,total:0}),H[L].count+=1,H[L].total+=V.value}return H}function v2(M,C){let H=Object.keys(M).filter(p=>p!==C).sort(),V=H.slice(-3),L=H.slice(-7),r=(p,o)=>p.length?p.reduce((A,d)=>A+M[d][o],0)/p.length:null,e=p=>{if(!p.length)return null;let o=p.reduce((d,l)=>d+M[l].total,0),A=p.reduce((d,l)=>d+M[l].count,0);return A>0?o/A:null},t=M[C],i=t?t.count:0,a=t?t.total:0;return{todayCount:i,todayTotal:a,todayAvgDuration:i>0?a/i:null,avg3dVisits:r(V,"count"),avg3dTotal:r(V,"total"),avg3dDuration:e(V),avg7dVisits:r(L,"count"),avg7dTotal:r(L,"total"),avg7dDuration:e(L),daysOfHistory:H.length}}function x2({lastVisitTs:M,now:C,thresholdHours:H}){let V=C instanceof Date?C.getTime():C;if(M==null)return{alerting:!0,hoursSince:null};let L=(V-M)/36e5;return{alerting:L>=H,hoursSince:L}}function Z2({todayTotal:M,avg7dTotal:C,daysOfHistory:H,thresholdPct:V,hourOfDay:L}){if(H<3||!C||L<18)return null;let r=V/100;return M<r*C?"low":M>(2-r)*C?"high":null}function s2(M,C,H){let V=H==null||H===""?"\u2014":H,L=parseFloat(C),r=!1;return M.warn_below!==void 0&&Number.isFinite(L)&&(r=L<M.warn_below),M.warn_above!==void 0&&Number.isFinite(L)&&(r=r||L>M.warn_above),M.warn_state!==void 0&&(r=r||C===M.warn_state),{display:V,warn:r}}function S2(M,C,H){return!C||!M||!M.states||!M.states[C]?H:M.states[C].state}function u2(M,C,H){if(!C||!M||!M.states||!M.states[C])return H;let V=M.states[C];return typeof M.formatEntityState=="function"?M.formatEntityState(V):V.state}function c2(M,C,H){if(H==null)return H;let V=C&&M&&M.states?M.states[C]:null;return!V||typeof M.formatEntityState!="function"?H:M.formatEntityState(V,H)}function d1(M,C){if(!C)return"";let H=M&&M.entities&&M.entities[C]&&M.entities[C].name;if(H)return H;let V=M&&M.states?M.states[C]:null;return V&&V.attributes&&V.attributes.friendly_name||C}function j(M,C){let H=new CustomEvent("hass-more-info",{bubbles:!0,composed:!0,detail:{entityId:C}});M.dispatchEvent(H)}function R(M,C,H,V){M.callService(C,H,V)}function p1(M){M.requestUpdate(),M.isUpdatePending&&M.performUpdate()}var e5={total_use:["total_use","total_time"],last_used_by:["last_used_by"],error:["error","error_message"],last_event:["max_last_event","litter_last_event"],state:["max_work_state","litter_state"]};function k1(M,C){let H={};if(!C||!M||!M.entities)return H;let V=Object.values(M.entities).filter(L=>L.device_id===C&&L.entity_id.startsWith("sensor."));for(let[L,r]of Object.entries(e5)){let e=V.find(t=>r.includes(t.translation_key));e&&(H[L]=e.entity_id)}return H}function m1(M,C){return!M||!M.total_use?"total_use":Array.isArray(C)&&C.length>1&&!M.last_used_by?"last_used_by":null}function b(M,C,H){if(!(!C||!M||!M.entities))return Object.values(M.entities).find(V=>V.device_id===C&&V.translation_key===H)}var t5=["wastebin","litter_weight","times_used","pura_air_battery"];function h2(M,C){let H=[];for(let V of t5){let L=b(M,C,V);L&&H.push({entity:L.entity_id})}return H}function O2(M,C,H){let V=[],L={action:"toggle"},r=b(M,C,"start_cleaning"),e=b(M,C,"pause_cleaning");r&&V.push({entity:r.entity_id,name:"Clean Now",tap_action:L,...e&&H?{visibility:[{condition:"state",entity:H,state_not:"cleaning_litter_box"}]}:{}}),e&&H&&V.push({entity:e.entity_id,name:"Pause Cleaning",tap_action:L,visibility:[{condition:"state",entity:H,state:"cleaning_litter_box"}]});let t=b(M,C,"start_maintenance"),i=b(M,C,"exit_maintenance");t&&V.push({entity:t.entity_id,name:"Start Maintenance",tap_action:L,...i&&H?{visibility:[{condition:"state",entity:H,state_not:"maintenance_mode"}]}:{}}),i&&H&&V.push({entity:i.entity_id,name:"Exit Maintenance",tap_action:L,visibility:[{condition:"state",entity:H,state:"maintenance_mode"}]});let a=b(M,C,"dump_litter");a&&V.push({entity:a.entity_id,name:"Dump Litter",tap_action:L});let p=b(M,C,"auto_cleaning");return p&&V.push({entity:p.entity_id,name:"Auto cleaning",tap_action:L}),V}var i5=new Set(["primary","accent","red","pink","purple","deep-purple","indigo","blue","light-blue","cyan","teal","green","light-green","lime","yellow","amber","orange","deep-orange","brown","light-grey","grey","dark-grey","blue-grey","black","white"]);function X(M){return M&&(i5.has(M)?`var(--${M}-color)`:M)}function o5(M,C){let H=C?.confirmation?.exemptions;return!H||!M?.user?.id?!1:H.some(V=>V.user===M.user.id)}function n1(M,C,H,V){let L=H||{action:"more-info"};if(L.confirmation&&!o5(C,L)){let r=L.confirmation.text||"Are you sure?";if(!window.confirm(r))return}switch(L.action){case"more-info":{let r=L.entity||V;r&&j(M,r);return}case"toggle":{let r=L.entity||V;if(!r)return;let e=r.split(".",1)[0];if(e==="button"||e==="input_button"){R(C,e,"press",{entity_id:r});return}let t=C.states[r],i=!t||t.state==="off";R(C,e,i?"turn_on":"turn_off",{entity_id:r});return}case"perform-action":case"call-service":{let r=L.perform_action||L.service;if(!r)return;let e=r.indexOf(".");if(e===-1)return;let t=r.slice(0,e),i=r.slice(e+1),a={...L.data||L.service_data||{},...L.target||{}};R(C,t,i,a);return}case"navigate":{if(!L.navigation_path)return;window.history.pushState(null,"",L.navigation_path),window.dispatchEvent(new CustomEvent("location-changed",{bubbles:!1,composed:!0,detail:{replace:!!L.navigation_replace}}));return}case"url":{L.url_path&&window.open(L.url_path);return}default:return}}var A5=500,y1=250;function f2(M){let C=0,H=0;return{onPointerDown(){C=Date.now()},onClick(V){let{hass:L,tapAction:r,holdAction:e,doubleTapAction:t,fallbackEntity:i}=M();if(e&&Date.now()-C>=A5){n1(V,L,e,i);return}let a=Date.now();if(t&&a-H<y1){H=0,n1(V,L,t,i);return}H=a,t?setTimeout(()=>{Date.now()-H>=y1&&n1(V,L,r,i)},y1):n1(V,L,r,i)}}}var a5="unknown";function g2(M){if(M!=null)return Array.isArray(M)?M:[M]}function k2(M,C,H){let V=M&&M.states&&C?M.states[C]:void 0;return V?H?V.attributes?.[H]:V.state:a5}function y2(M,C){switch(C.condition){case"state":{let H=k2(M,C.entity,C.attribute),V=g2(C.state),L=g2(C.state_not);return!(!V&&!L||V&&!V.includes(H)||L&&L.includes(H))}case"numeric_state":{let H=k2(M,C.entity,C.attribute),V=Number(H);return!(Number.isNaN(V)||C.above!=null&&!(V>C.above)||C.below!=null&&!(V<C.below))}case"and":return l1(C.conditions,M);case"or":return!C.conditions||C.conditions.length===0?!0:C.conditions.some(H=>y2(M,H));case"not":return!l1(C.conditions,M);default:return!0}}function l1(M,C){return!M||M.length===0?!0:M.every(H=>y2(C,H))}var w2=$`
...
`;var b2=["unavailable","unknown","no_events_yet"],w1="#9e9e9e",B2="PETKIT PURAMAX";var P2={left:46,right:10,top:10,bottom:28};var _=class extends x{static getConfigElement(){return document.createElement("petkit-puramax-card-editor")}static getStubConfig(C){let H=C&&C.entities?Object.values(C.entities).find(t=>t.platform==="petkit"):null,V=H?H.device_id:"",L=k1(C,V),r=h2(C,V),e=O2(C,V,L.state);return{type:"custom:petkit-puramax-card",title:"PETKIT PURAMAX",device_id:V,...r.length?{info_row:r}:{},...e.length?{controls_row:e}:{},cats:[{name:"My Cat",color:"blue"}]}}constructor(){super(),this._dayOffset=0,this._chartVisits=[],this._chartEventHist=[],this._analytics=null,this._configErrorMsg=null,this._tapHandlersByIndex=new Map}setConfig(C){if(!C)throw new Error("petkit-puramax-card: config is required");let H=C.device_id!==void 0;if(!H&&!C.device_entities)throw new Error('petkit-puramax-card: "device_entities" is required in config (or set "device_id")');let V=C.device_entities||{};if(!H&&m1(V)==="total_use")throw new Error('petkit-puramax-card: "device_entities.total_use" is required in config (or set "device_id")');if(!C.cats)throw new Error('petkit-puramax-card: "cats" is required in config');if(!Array.isArray(C.cats)||C.cats.length<1)throw new Error('petkit-puramax-card: "cats" must be a non-empty array');if(!H&&m1(V,C.cats)==="last_used_by")throw new Error('petkit-puramax-card: "device_entities.last_used_by" is required in config when more than one cat is configured (or set "device_id")');C.cats.forEach((L,r)=>{if(!L||!L.name)throw new Error(`petkit-puramax-card: cats[${r}].name is required`);if(!L.color)throw new Error(`petkit-puramax-card: cats[${r}].color is required`)}),this._config={...C,device_entities:V},this._dayOffset=0,this._analytics=null,this._chartVisits=[],this._chartEventHist=[],this._tapHandlersByIndex=new Map,this._deviceEntities=this._resolveDeviceEntities(),this._flush()}_resolveDeviceEntities(){return{...k1(this._hass,this._config.device_id),...this._config.device_entities}}_configError(){if(this._config.device_id===void 0)return null;let C=!this._config.device_id,H=m1(this._deviceEntities,this._config.cats);return H==="total_use"?C?'A PetKit device is required. Select one in the card editor, or set "device_entities.total_use" manually.':'Could not auto-detect a "total use" sensor on the selected device. Set "device_entities.total_use" in the config to override.':H==="last_used_by"?C?'A PetKit device is required (or set "device_entities.last_used_by" manually) since more than one cat is configured.':'Could not auto-detect a "last used by" sensor on the selected device (required for more than one cat). Set "device_entities.last_used_by" in the config to override.':null}set hass(C){let H=this._hass;this._hass=C,this._deviceEntities=this._resolveDeviceEntities(),this._built?this._maybeRefreshOnNewVisit(H):(this._built=!0,this._build()),this._flush()}get hass(){return this._hass}_flush(){p1(this)}getCardSize(){return 14}_build(){let C=this._configError();this._configErrorMsg=C,!C&&(this._loadDay(),this._loadAnalytics(),this._startNoVisitTimer())}connectedCallback(){super.connectedCallback(),this._hass&&!this._built&&(this._built=!0,this._build())}disconnectedCallback(){super.disconnectedCallback(),this._noVisitTimer&&(clearInterval(this._noVisitTimer),this._noVisitTimer=null)}_startNoVisitTimer(){this._noVisitTimer||(this._noVisitTimer=setInterval(()=>this._checkNoVisitAlerts(),300*1e3))}_maybeRefreshOnNewVisit(C){if(!C)return;let H=this._deviceEntities.total_use,V=C.states[H],L=this._hass.states[H];L&&(!V||V.last_changed!==L.last_changed)&&(this._dayOffset===0&&this._loadDay(),this._loadAnalytics())}_s(C,H){return S2(this._hass,C,H)}async _fetchVisits({start:C,end:H}){let V=this._config,L=this._deviceEntities,r=A1({startTime:C,endTime:H,entityIds:[L.total_use]}),e=[this._hass.callWS(r)];if(V.cats.length>1){let A=A1({startTime:C,endTime:H,entityIds:[L.last_used_by],includeStartTimeState:!0});e.push(this._hass.callWS(A))}let t={},i={};try{let[A,d]=await Promise.all(e);t=A||{},i=d||{}}catch{}let a=A2(t[L.total_use],{minDelta:0,maxDelta:1800}),p;if(V.cats.length>1){let A=V.cats.map(l=>l.name),d=a2(i[L.last_used_by],A);p=d2(a,d)}else p=a.map(A=>({...A,cat:V.cats[0].name}));let o=new Map(V.cats.map(A=>[A.name,A]));return p.map(A=>({cat:A.cat===F?this._unknownCat():o.get(A.cat)||null,duration:A.value,ts:A.ts}))}_unknownCat(){return{name:F,color:this._config.unknown_cat_color||w1}}async _loadDay(){if(!this._hass)return;let C=this._deviceEntities,{start:H,end:V}=o1(this._dayOffset),L=[],r=[];try{let[e,t]=await Promise.all([this._fetchVisits({start:H,end:V}),C.last_event?this._hass.callWS(A1({startTime:H,endTime:V,entityIds:[C.last_event]})):Promise.resolve({})]);L=e,r=(t||{})[C.last_event]||[]}catch{L=[],r=[]}this._chartVisits=L,this._chartEventHist=r,this._flush()}async _loadAnalytics(){if(!this._hass)return;let C=this._config,H=new Date,V=new Date(H.getTime()-168*3600*1e3),L=[];try{L=await this._fetchVisits({start:V,end:H})}catch{L=[]}let r=f1(H.getTime()),e=g1(C.cats,t=>{let i=L.filter(o=>o.cat===t).map(o=>({value:o.duration,ts:o.ts})),a=l2(i,{dayKeyFn:f1}),p=i.length?Math.max(...i.map(o=>o.ts)):null;return{...v2(a,r),lastVisitTs:p}});this._analytics=e,this._checkNoVisitAlerts(),this._flush()}_checkNoVisitAlerts(){if(!this._analytics||!this._built)return;let C=this._config,H=C.no_visit_alert_hours??8,V=Date.now();this._notifiedCats||(this._notifiedCats=new Set),C.cats.forEach(L=>{let r=this._analytics[L.name];if(!r)return;let e=x2({lastVisitTs:r.lastVisitTs,now:V,thresholdHours:H});r.noVisitAlert=e;let t=this._notifiedCats.has(L.name);e.alerting&&!t?(this._notifiedCats.add(L.name),this._sendNoVisitNotification(L,e)):!e.alerting&&t&&this._notifiedCats.delete(L.name)}),this._flush()}_sendNoVisitNotification(C,H){let V=this._config.notify_service;if(!V||!this._hass)return;let L=V.indexOf(".");if(L===-1)return;let r=V.slice(0,L),e=V.slice(L+1);if(r!=="notify"||!e)return;let t=H.hoursSince==null?`${C.name} hasn't used the litter box yet in the tracked history.`:`${C.name} hasn't used the litter box in over ${Math.floor(H.hoursSince)}h.`;R(this._hass,"notify",e,{message:t,title:"Litter box alert"})}_changeDay(C){this._dayOffset+=C,this._dayOffset>0&&(this._dayOffset=0),this._flush(),this._loadDay()}_iconTemplate(C,H){return C?m`<ha-icon icon=${C}></ha-icon>`:H?m`<ha-state-icon .stateObj=${this._hass?.states?.[H]}></ha-state-icon>`:m`<ha-icon icon="mdi:information-outline"></ha-icon>`}_entityLabel(C,H){return C||d1(this._hass,H)}_tapHandlersFor(C){let H=this._tapHandlersByIndex.get(C);return H||(H=f2(()=>{let V=(this._config.controls_row||[])[C]||{};return{hass:this._hass,tapAction:V.tap_action,holdAction:V.hold_action,doubleTapAction:V.double_tap_action,fallbackEntity:V.entity}}),this._tapHandlersByIndex.set(C,H)),H}render(){if(this._configErrorMsg)return m`<ha-card><div style="padding: 16px;"><ha-alert alert-type="error">${this._configErrorMsg}</ha-alert></div></ha-card>`;if(!this._config)return n;let C=this._config;return m`
    ...
    `}_renderInfoChip(C){let H=this._s(C.entity,null),V=u2(this._hass,C.entity,null),{display:L,warn:r}=s2(C,H,V);return this._chipTemplate(C.icon,this._entityLabel(C.name,C.entity),L,r,C.entity)}_chipTemplate(C,H,V,L,r){let e=()=>{r&&j(this,r)};return m`
      <div
    ...
    `}_renderControlsRow(){let V=(this._config.controls_row||[]).map((L,r)=>({spec:L,i:r})).filter(({spec:L})=>l1(L.visibility,this._hass));return e2(V,({i:L})=>L,({spec:L,i:r})=>{let e=this._entityLabel(L.name,L.entity),t=this._s(L.entity,null)==="on",i=this._tapHandlersFor(r);return m`
          <ha-control-button
    ...
    `}_visits(){return(this._chartVisits||[]).filter(C=>C.cat).sort((C,H)=>C.ts-H.ts)}_renderChartArea(){let C=this._visits(),H=600,V=240,L=P2,r=Math.max(60,...C.map(v=>v.duration)),e=p2(r),t=Math.ceil(r/e)*e,{start:i}=o1(this._dayOffset),{xFor:a,yFor:p}=m2({dayStart:i,niceMax:t,width:H,height:V,padding:L}),{vertical:o,horizontal:A}=n2({niceMax:t,yStep:e,width:H,height:V,padding:L}),d=(V-L.bottom)/V*100,l=L.left/H*100;return m`
      <div class="chart-wrap">
        <svg viewBox="0 0 ${H} ${V}" class="chart-svg">
          ...
          ${C.map((v,E)=>{let u=a(v.ts),v1=p(v.duration),B1=V-L.bottom,P1=X(v.cat.color);return e1`
              <line x1="${u}" y1="${B1}" x2="${u}" y2="${v1}" stroke="${P1}" stroke-width="2" />
              <circle class="visit-point" cx="${u}" cy="${v1}" r="5" fill="${P1}" />
              <line class="visit-hit" data-idx="${E}" x1="${u}" y1="${B1}" x2="${u}" y2="${v1}" stroke="transparent" stroke-width="16"
                @mouseenter=${$2=>this._showChartTooltip($2,v)}
    ...
    `}_renderRecordsSection(){let C=this._config,H=this._chartEventHist||[],V=this._deviceEntities.last_event,L=(C.event_exclude||b2).map(e=>String(e).toLowerCase()),r=H.map(e=>{let{state:t,ts:i}=a1(e)??{};return!t||!i||L.includes(t.toLowerCase())?null:{ts:i,icon:"mdi:information-outline",color:"var(--secondary-text-color)",text:c2(this._hass,V,t)}}).filter(Boolean);return r.sort((e,t)=>t.ts-e.ts),m`
    ...
    `}_renderAnalyticsSection(){if(!this._analytics)return n;let C=this._config,H=C.decline_threshold_pct||60,V=new Date().getHours(),L=[],r=C.cats.map(t=>{let i=this._analytics[t.name]||{},a=Z2({todayTotal:i.todayTotal,avg7dTotal:i.avg7dTotal,daysOfHistory:i.daysOfHistory,thresholdPct:H,hourOfDay:V});return a==="low"?L.push(`${t.name}'s usage today is well below their recent average \u2014 worth a check.`):a==="high"&&L.push(`${t.name}'s usage today is well above their recent average \u2014 worth a check.`),m`
    ...
    `}};B(_,"styles",w2),B(_,"properties",{_config:{state:!0},_dayOffset:{state:!0},_chartVisits:{state:!0},_chartEventHist:{state:!0},_analytics:{state:!0},_configErrorMsg:{state:!0}});var T2="M22,21H2V3H4V19H6V10H10V19H12V6H16V19H18V14H22V21Z";var F2="M21 11H3V9H21V11M21 13H3V15H21V13Z";var R2="M13 5C15.21 5 17 6.79 17 9C17 10.5 16.2 11.77 15 12.46V11.24C15.61 10.69 16 9.89 16 9C16 7.34 14.66 6 13 6S10 7.34 10 9C10 9.89 10.39 10.69 11 11.24V12.46C9.8 11.77 9 10.5 9 9C9 6.79 10.79 5 13 5M20 20.5C19.97 21.32 19.32 21.97 18.5 22H13C12.62 22 12.26 21.85 12 21.57L8 17.37L8.74 16.6C8.93 16.39 9.2 16.28 9.5 16.28H9.7L12 18V9C12 8.45 12.45 8 13 8S14 8.45 14 9V13.47L15.21 13.6L19.15 15.79C19.68 16.03 20 16.56 20 17.14V20.5M20 2H4C2.9 2 2 2.9 2 4V12C2 13.11 2.9 14 4 14H8V12L4 12L4 4H20L20 12H18V14H20V13.96L20.04 14C21.13 14 22 13.09 22 12V4C22 2.9 21.11 2 20 2Z";var _2="M8.35,3C9.53,2.83 10.78,4.12 11.14,5.9C11.5,7.67 10.85,9.25 9.67,9.43C8.5,9.61 7.24,8.32 6.87,6.54C6.5,4.77 7.17,3.19 8.35,3M15.5,3C16.69,3.19 17.35,4.77 17,6.54C16.62,8.32 15.37,9.61 14.19,9.43C13,9.25 12.35,7.67 12.72,5.9C13.08,4.12 14.33,2.83 15.5,3M3,7.6C4.14,7.11 5.69,8 6.5,9.55C7.26,11.13 7,12.79 5.87,13.28C4.74,13.77 3.2,12.89 2.41,11.32C1.62,9.75 1.9,8.08 3,7.6M21,7.6C22.1,8.08 22.38,9.75 21.59,11.32C20.8,12.89 19.26,13.77 18.13,13.28C17,12.79 16.74,11.13 17.5,9.55C18.31,8 19.86,7.11 21,7.6M19.33,18.38C19.37,19.32 18.65,20.36 17.79,20.75C16,21.57 13.88,19.87 11.89,19.87C9.9,19.87 7.76,21.64 6,20.75C5,20.26 4.31,18.96 4.44,17.88C4.62,16.39 6.41,15.59 7.47,14.5C8.88,13.09 9.88,10.44 11.89,10.44C13.89,10.44 14.95,13.05 16.3,14.5C17.41,15.72 19.26,16.75 19.33,18.38Z";var D2="M4,9H20V11H4V9M4,13H14V15H4V13Z";var E2="M3 11H11V3H3M5 5H9V9H5M13 21H21V13H13M15 15H19V19H15M3 21H11V13H3M5 15H9V19H5M13 3V11H21V3M19 9H15V5H19Z";var N2=$`
...
`;var v5=D2,x5=_2,Z5=E2,s5=R2,S5=T2,u5=F2,O=M=>M.label||M.name,c5=[{name:"name",label:"Name",selector:{text:{}}}],h5=[{name:"color",label:"Color",selector:{ui_color:{}}}],O5={name:"My Cat",color:"blue"},f5=[{name:"entity",label:"Entity",selector:{entity:{}}},{name:"name",label:"Name",selector:{text:{}}},{name:"icon",label:"Icon",selector:{icon:{}}},{name:"warn_below",label:"Warn below",selector:{number:{mode:"box"}}},{name:"warn_above",label:"Warn above",selector:{number:{mode:"box"}}},{name:"warn_state",label:"Warn state",selector:{text:{}}}],g5=[{name:"entity",label:"Entity",selector:{entity:{}}},{name:"name",label:"Name",selector:{text:{}}},{name:"icon",label:"Icon",selector:{icon:{}}},{name:"tap_action",label:"Tap action",selector:{ui_action:{}}},{name:"hold_action",label:"Hold action",selector:{ui_action:{}}},{name:"double_tap_action",label:"Double-tap action",selector:{ui_action:{}}}],k5=[{name:"device_id",label:"PetKit device",selector:{device:{filter:{integration:"petkit"}}}}],y5=[{name:"title",label:"Title",selector:{text:{}}}],w5=[{name:"show_state",label:"Show state",selector:{boolean:{}}},{name:"show_history",label:"Show history (visit chart)",selector:{boolean:{}}},{name:"show_working_records",label:"Show Working Records",selector:{boolean:{}}},{name:"show_analytics",label:"Show Analytics",selector:{boolean:{}}}],b5=[{name:"decline_threshold_pct",label:"Decline/spike alert threshold (%)",selector:{number:{min:10,max:100,mode:"box"}}},{name:"no_visit_alert_hours",label:"Warn if no visit in (hours)",selector:{number:{min:1,max:168,mode:"box"}}},{name:"notify_service",label:"Push a notification too (optional)",selector:{entity:{domain:"notify"}}}],D=class extends x{constructor(){super(),this._detailEditor=null}setConfig(C){this._config=C||{},this._flush()}set hass(C){this._hass=C,this._flush()}get hass(){return this._hass}_flush(){p1(this)}_fireConfigChanged(C){this._config=C,this._flush(),this.dispatchEvent(new CustomEvent("config-changed",{bubbles:!0,composed:!0,detail:{config:C}}))}_resolvedName(C){return C.name?C.name:d1(this._hass,C.entity)||C.entity||""}_entityContext(C){let H=this._hass;if(!H||!C||!H.entities)return null;let V=H.entities[C];if(!V)return null;let L=V.device_id&&H.devices?H.devices[V.device_id]:null,r=V.area_id||L&&L.area_id,e=r&&H.areas?H.areas[r]:null,t=L&&(L.name_by_user||L.name),i=e&&e.name;return i&&t?`${i} \u2192 ${t}`:i||t||null}render(){if(!this._config)return n;let C=this._resolveDetailSpec();return m`
      <div class="detail-view" ?hidden=${!C}>${C?this._renderDetail(C):n}</div>
      <div class="list-view" ?hidden=${!!C}>${this._renderList()}</div>
    `}_resolveDetailSpec(){if(!this._detailEditor)return null;let{kind:C,index:H}=this._detailEditor,V=C==="info"?"info_row":"controls_row",L=(this._config[V]||[])[H];return L||(queueMicrotask(()=>{this._detailEditor=null,this._flush()}),null)}_renderDetail(C){let{kind:H,index:V}=this._detailEditor,L=H==="info"?f5:g5;return m`
    ...
    `}_dragHandleTemplate(){return m`
      <div class="handle">
        <ha-svg-icon .path=${u5}></ha-svg-icon>
      </div>
    ...
    `}_updateCat(C,H){this._updateItem("cats",C,H)}_moveCat(C,H){this._moveItem("cats",C,H)}_addCat(){this._addItem("cats",{...O5})}_removeCat(C){this._removeItem("cats",C)}_updateItem(C,H,V){let L=[...this._config[C]||[]];L[H]=V,this._fireConfigChanged({...this._config,[C]:L})}_moveItem(C,H,V){let L=(this._config[C]||[]).concat();L.splice(V,0,L.splice(H,1)[0]),this._fireConfigChanged({...this._config,[C]:L})}_addItem(C,H){let V=[...this._config[C]||[],H];this._fireConfigChanged({...this._config,[C]:V})}_removeItem(C,H){let V=(this._config[C]||[]).filter((L,r)=>r!==H);this._fireConfigChanged({...this._config,[C]:V})}_renderRowsList(C,H,V,L){let r=this._config[C]||[];return m`
      <ha-sortable
        handle-selector=".handle"
