function C(a){let t=Math.round(a||0);if(t<60)return`${t}s`;let e=Math.floor(t/60),o=t%60;return`${e}m${o.toString().padStart(2,"0")}s`}function M(a){let t=Math.round(a||0),e=Math.floor(t/60),o=t%60;return`${e.toString().padStart(2,"0")}'${o.toString().padStart(2,"0")}"`}function V(a){let t=Math.floor(a);return t<1?"under 1h":t<48?`${t}h`:`${Math.floor(t/24)}d`}function _(a){return String(a).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function A(a,t=new Date){let e=new Date(t.getFullYear(),t.getMonth(),t.getDate());e.setDate(e.getDate()+a);let o=new Date(e);return o.setDate(o.getDate()+1),{start:e,end:o}}function U(a,t=new Date){if(a===0)return"Today";if(a===-1)return"Yesterday";let{start:e}=A(a,t);return e.toLocaleDateString(void 0,{weekday:"short",month:"short",day:"numeric"})}function N(a){let t=new Date(a);return`${t.getFullYear()}-${t.getMonth()}-${t.getDate()}`}function T({startTime:a,endTime:t,entityIds:e,includeStartTimeState:o=!1}){let s=a instanceof Date?a.toISOString():a,i=t instanceof Date?t.toISOString():t;return{type:"history/history_during_period",start_time:s,end_time:i,entity_ids:e,minimal_response:!1,no_attributes:!0,include_start_time_state:o}}function Et(a){if(!a)return null;let t=a.s??a.state,e=parseFloat(t),o=a.lu?a.lu*1e3:a.last_changed?Date.parse(a.last_changed):null;return!Number.isFinite(e)||!o||Number.isNaN(o)?null:{value:e,ts:o}}function z(a,{minDelta:t=0,maxDelta:e=1/0}={}){if(!Array.isArray(a))return[];let o=a.map(Et).filter(Boolean).sort((i,n)=>i.ts-n.ts),s=[];for(let i=1;i<o.length;i++){let n=o[i].value-o[i-1].value;if(n<=t||n>=e)continue;let r=o[i+1];r&&r.value===o[i-1].value||s.push({value:n,ts:o[i].ts})}return s}var Ct="unknown_pet",w="Unknown";function P(a,t){if(!Array.isArray(a))return[];let e=new Set(t),o=[];for(let s of a){let i=s.s??s.state,n;if(e.has(i))n=i;else if(i===Ct)n=w;else continue;let r=s.lu?s.lu*1e3:s.last_changed?Date.parse(s.last_changed):null;!r||Number.isNaN(r)||o.push({cat:n,ts:r})}return o.sort((s,i)=>s.ts-i.ts),o}function W(a,t){let e=a.length,o=new Array(e).fill(null),s=0,i=null;for(let n=0;n<e;n++){let r=a[n].ts,c=n===0?-1/0:(a[n-1].ts+r)/2,h=n===e-1?1/0:(r+a[n+1].ts)/2;for(;s<t.length&&t[s].ts<c;)i=t[s].cat,s++;let d=null,m=1/0;for(;s<t.length&&t[s].ts<h;){let u=Math.abs(t[s].ts-r);u<m&&(m=u,d=t[s].cat),i=t[s].cat,s++}o[n]=d!==null?d:i}return a.map((n,r)=>({...n,cat:o[r]}))}var kt=[10,15,30,60,120,180,300,600,900,1800,3600];function j(a){for(let t of kt)if(a/t<=5)return t;return Math.ceil(a/5/60)*60}function K({dayStart:a,niceMax:t,width:e,height:o,padding:s}){let{left:i,right:n,top:r,bottom:c}=s,h=e-i-n,d=o-r-c,m=a.getTime();return{xFor:g=>{let D=(g-m)/36e5;return i+D/24*h},yFor:g=>t?o-c-g/t*d:o-c}}function q({niceMax:a,yStep:t,width:e,height:o,padding:s}){let{left:i,right:n,top:r,bottom:c}=s,h=e-i-n,d=o-r-c,m=[4,8,12,16,20].map(p=>({hour:p,x:i+p/24*h,label:`${p.toString().padStart(2,"0")}:00`})),u=[];if(t>0)for(let p=0;p<=a;p+=t){let g=a?o-c-p/a*d:o-c;u.push({value:p,y:g,label:M(p)})}return{vertical:m,horizontal:u}}function G(a,{dayKeyFn:t}){let e={};for(let o of a||[]){let s=t(o.ts);e[s]||(e[s]={count:0,total:0}),e[s].count+=1,e[s].total+=o.value}return e}function X(a,t){let e=Object.keys(a).filter(d=>d!==t).sort(),o=e.slice(-3),s=e.slice(-7),i=(d,m)=>d.length?d.reduce((u,p)=>u+a[p][m],0)/d.length:null,n=d=>{if(!d.length)return null;let m=d.reduce((p,g)=>p+a[g].total,0),u=d.reduce((p,g)=>p+a[g].count,0);return u>0?m/u:null},r=a[t],c=r?r.count:0,h=r?r.total:0;return{todayCount:c,todayTotal:h,todayAvgDuration:c>0?h/c:null,avg3dVisits:i(o,"count"),avg3dTotal:i(o,"total"),avg3dDuration:n(o),avg7dVisits:i(s,"count"),avg7dTotal:i(s,"total"),avg7dDuration:n(s),daysOfHistory:e.length}}function Y({lastVisitTs:a,now:t,thresholdHours:e}){let o=t instanceof Date?t.getTime():t;if(a==null)return{alerting:!0,hoursSince:null};let s=(o-a)/36e5;return{alerting:s>=e,hoursSince:s}}function J(a,t){let e=t;a.value_map&&t in a.value_map?e=a.value_map[t]:t!==null&&a.unit&&(e=`${t}${a.unit}`),e==null&&(e="\u2014");let o=parseFloat(t),s=!1;return a.warn_below!==void 0&&Number.isFinite(o)&&(s=o<a.warn_below),a.warn_above!==void 0&&Number.isFinite(o)&&(s=s||o>a.warn_above),a.warn_state!==void 0&&(s=s||t===a.warn_state),{display:e,warn:s}}function Q(a,t,e){return!t||!a||!a.states||!a.states[t]?e:a.states[t].state}function I(a,t){let e=new CustomEvent("hass-more-info",{bubbles:!0,composed:!0,detail:{entityId:t}});a.dispatchEvent(e)}function L(a,t,e,o){a.callService(t,e,o)}function k(a,t){t&&L(a,"button","press",{entity_id:t})}var At={total_use:["total_use","total_time"],last_used_by:["last_used_by"],error:["error","error_message"],last_event:["max_last_event","litter_last_event"],state:["max_work_state","litter_state"]};function Z(a,t){let e={};if(!t||!a||!a.entities)return e;let o=Object.values(a.entities).filter(s=>s.device_id===t&&s.entity_id.startsWith("sensor."));for(let[s,i]of Object.entries(At)){let n=o.find(r=>i.includes(r.translation_key));n&&(e[s]=n.entity_id)}return e}var tt=`
...
`;var et={maintenance_mode:"Maintenance mode",manual_odor_completed:"Manual odor removal done",auto_cleaning_completed:"Auto cleaning done"},ot=["unavailable","unknown","no_events_yet"],H="#9e9e9e",st="PETKIT PURAMAX",it=60,nt=8,at=1800,rt=600,ct=240,lt={left:46,right:10,top:10,bottom:28};var S=class extends HTMLElement{static getConfigElement(){return document.createElement("petkit-puramax-card-editor")}static getStubConfig(){return{type:"custom:petkit-puramax-card",title:"PETKIT PURAMAX",device_entities:{error:"sensor.example_petkit_error",last_event:"sensor.example_petkit_last_event",state:"sensor.example_petkit_state",total_use:"sensor.example_petkit_total_use"},cats:[{name:"Example Cat",color:"#4fc3f7"}]}}setConfig(t){if(!t)throw new Error("petkit-puramax-card: config is required");if(!t.device_id&&!t.device_entities)throw new Error('petkit-puramax-card: "device_entities" is required in config (or set "device_id")');if(t.device_entities=t.device_entities||{},!t.device_id&&!t.device_entities.total_use)throw new Error('petkit-puramax-card: "device_entities.total_use" is required in config (or set "device_id")');if(!t.cats)throw new Error('petkit-puramax-card: "cats" is required in config');if(!Array.isArray(t.cats)||t.cats.length<1)throw new Error('petkit-puramax-card: "cats" must be a non-empty array');if(!t.device_id&&t.cats.length>1&&!t.device_entities.last_used_by)throw new Error('petkit-puramax-card: "device_entities.last_used_by" is required in config when more than one cat is configured (or set "device_id")');t.cats.forEach((e,o)=>{if(!e||!e.name)throw new Error(`petkit-puramax-card: cats[${o}].name is required`);if(!e.color)throw new Error(`petkit-puramax-card: cats[${o}].color is required`)}),this._config=t,this._dayOffset=0,this._analytics=null,this._chartData=null,this._loadingChart=!1,this._loadingAnalytics=!1,this._deviceEntities=this._resolveDeviceEntities(),this.shadowRoot||this.attachShadow({mode:"open"}),this._render()}_resolveDeviceEntities(){return{...Z(this._hass,this._config.device_id),...this._config.device_entities}}_configError(){return this._config.device_id?this._deviceEntities.total_use?this._config.cats.length>1&&!this._deviceEntities.last_used_by?'Could not auto-detect a "last used by" sensor on the selected device (required for more than one cat). Set "device_entities.last_used_by" in the config to override.':null:'Could not auto-detect a "total use" sensor on the selected device. Set "device_entities.total_use" in the config to override.':null}_renderError(t){this.shadowRoot||this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=`<ha-card><div style="padding: 16px;"><ha-alert alert-type="error">${_(t)}</ha-alert></div></ha-card>`}set hass(t){let e=this._hass;if(this._hass=t,this._deviceEntities=this._resolveDeviceEntities(),!this._built){this._built=!0,this._build();return}this._updateLiveValues(),this._maybeRefreshOnNewVisit(e)}get hass(){return this._hass}getCardSize(){return 14}_build(){let t=this._configError();if(t){this._renderError(t);return}this._render(),this._loadDay(),this._loadAnalytics(),this._startNoVisitTimer()}connectedCallback(){this._hass&&!this._built&&(this._built=!0,this._build())}disconnectedCallback(){this._noVisitTimer&&(clearInterval(this._noVisitTimer),this._noVisitTimer=null)}_startNoVisitTimer(){this._noVisitTimer||(this._noVisitTimer=setInterval(()=>this._checkNoVisitAlerts(),300*1e3))}_maybeRefreshOnNewVisit(t){if(!t)return;let e=this._deviceEntities.total_use,o=t.states[e],s=this._hass.states[e];s&&(!o||o.last_changed!==s.last_changed)&&(this._dayOffset===0&&this._loadDay(),this._loadAnalytics())}_s(t,e){return Q(this._hass,t,e)}async _fetchVisits({start:t,end:e}){let o=this._config,s=this._deviceEntities,i=T({startTime:t,endTime:e,entityIds:[s.total_use]}),n=[this._hass.callWS(i)];if(o.cats.length>1){let u=T({startTime:t,endTime:e,entityIds:[s.last_used_by],includeStartTimeState:!0});n.push(this._hass.callWS(u))}let r={},c={};try{let[u,p]=await Promise.all(n);r=u||{},c=p||{}}catch{}let h=z(r[s.total_use],{minDelta:0,maxDelta:at}),d;if(o.cats.length>1){let u=o.cats.map(g=>g.name),p=P(c[s.last_used_by],u);d=W(h,p)}else d=h.map(u=>({...u,cat:o.cats[0].name}));let m=new Map(o.cats.map(u=>[u.name,u]));return d.map(u=>({cat:u.cat===w?this._unknownCat():m.get(u.cat)||null,duration:u.value,ts:u.ts}))}_unknownCat(){return{name:w,color:this._config.unknown_cat_color||H}}async _loadDay(){if(!this._hass)return;this._loadingChart=!0,this._renderChartArea();let t=this._deviceEntities,{start:e,end:o}=A(this._dayOffset),s=[],i=[];try{let[n,r]=await Promise.all([this._fetchVisits({start:e,end:o}),t.last_event?this._hass.callWS(T({startTime:e,endTime:o,entityIds:[t.last_event]})):Promise.resolve({})]);s=n,i=(r||{})[t.last_event]||[]}catch{s=[],i=[]}this._chartVisits=s,this._chartEventHist=i,this._loadingChart=!1,this._renderChartArea()}async _loadAnalytics(){if(!this._hass)return;this._loadingAnalytics=!0,this._renderAnalyticsArea();let t=this._config,e=new Date,o=new Date(e.getTime()-168*3600*1e3),s=[];try{s=await this._fetchVisits({start:o,end:e})}catch{s=[]}let i=N(e.getTime()),n={};t.cats.forEach(r=>{let c=s.filter(m=>m.cat===r).map(m=>({value:m.duration,ts:m.ts})),h=G(c,{dayKeyFn:N}),d=c.length?Math.max(...c.map(m=>m.ts)):null;n[r.name]={...X(h,i),lastVisitTs:d}}),this._analytics=n,this._loadingAnalytics=!1,this._checkNoVisitAlerts(),this._renderAnalyticsArea()}_checkNoVisitAlerts(){if(!this._analytics||!this._built)return;let t=this._config,e=t.no_visit_alert_hours??nt,o=Date.now();this._notifiedCats||(this._notifiedCats=new Set),t.cats.forEach(s=>{let i=this._analytics[s.name];if(!i)return;let n=Y({lastVisitTs:i.lastVisitTs,now:o,thresholdHours:e});i.noVisitAlert=n;let r=this._notifiedCats.has(s.name);n.alerting&&!r?(this._notifiedCats.add(s.name),this._sendNoVisitNotification(s,n)):!n.alerting&&r&&this._notifiedCats.delete(s.name)}),this._renderAnalyticsArea()}_sendNoVisitNotification(t,e){let o=this._config.notify_service;if(!o||!this._hass)return;let s=o.indexOf(".");if(s===-1)return;let i=o.slice(0,s),n=o.slice(s+1);if(i!=="notify"||!n)return;let r=e.hoursSince==null?`${t.name} hasn't used the litter box yet in the tracked history.`:`${t.name} hasn't used the litter box in over ${Math.floor(e.hoursSince)}h.`;L(this._hass,"notify",n,{message:r,title:"Litter box alert"})}_render(){let t=this._config;this.shadowRoot.innerHTML=`
      <style>${tt}</style>
      <ha-card>
        <div class="header">
    ...
    `,this.shadowRoot.getElementById("prev-day").addEventListener("click",()=>this._changeDay(-1)),this.shadowRoot.getElementById("next-day").addEventListener("click",()=>this._changeDay(1)),this._updateLiveValues(),this._renderChartArea(),this._renderAnalyticsArea()}_changeDay(t){this._dayOffset+=t,this._dayOffset>0&&(this._dayOffset=0),this._loadDay()}_updateLiveValues(){if(!this._built)return;let t=this._config,e=this._deviceEntities,o=this.shadowRoot.getElementById("status-row");if(o){let i=this._s(e.error,"no_error"),n=i&&i!=="no_error",r=t.info_row||[];if(o.innerHTML=[...r.map(c=>this._renderInfoChip(c)),n?this._chip("mdi:alert","Error",i.replace(/_/g," "),!0,e.error):""].join(""),!o.dataset.bound){o.dataset.bound="1";let c=h=>{let d=h.target.closest(".chip[data-entity]");d&&I(this,d.dataset.entity)};o.addEventListener("click",c),o.addEventListener("keydown",h=>{(h.key==="Enter"||h.key===" ")&&(h.preventDefault(),c(h))})}}let s=this.shadowRoot.getElementById("controls-row");if(s&&!s.dataset.bound){let i=t.controls_row||[];s.innerHTML=i.map((n,r)=>`
      <ha-control-button class="ctrl-btn" id="ctrl-${r}" label="${_(n.name||"")}">
        <div class="ctrl-btn-content">
          <ha-icon icon="${_(n.icon||"mdi:help")}"></ha-icon>
          <span>${_(n.name||"")}</span>
        </div>
      </ha-control-button>
    `).join(""),s.dataset.bound="1",i.forEach((n,r)=>{this.shadowRoot.getElementById(`ctrl-${r}`).addEventListener("click",()=>this._runControlAction(n))})}}_renderInfoChip(t){let e=this._s(t.entity,null),{display:o,warn:s}=J(t,e);return this._chip(t.icon||"mdi:information-outline",t.name||t.entity,o,s,t.entity)}_runControlAction(t){switch(t.action){case"press":{t.confirm?window.confirm(t.confirm)&&k(this._hass,t.entity):k(this._hass,t.entity);break}case"toggle_maintenance":{let e=t.state_entity||this._deviceEntities.state;this._s(e,"")==="maintenance"?k(this._hass,t.exit_entity):k(this._hass,t.start_entity);break}case"toggle":{L(this._hass,"homeassistant","toggle",{entity_id:t.entity});break}case"more_info":{I(this,t.entity);break}default:break}}_chip(t,e,o,s,i){let n=i?` data-entity="${_(i)}" tabindex="0"`:"";return`
      <div class="chip ${s?"warn":""} ${i?"tappable":""}"${n}>
        <ha-icon icon="${_(t)}"></ha-icon>
        <div class="chip-text"><div class="chip-label">${_(e)}</div><div class="chip-value">${_(o)}</div></div>
      </div>`}_renderChartArea(){if(!this._built)return;let t=this.shadowRoot.getElementById("day-label");t&&(t.textContent=U(this._dayOffset));let e=this.shadowRoot.getElementById("next-day");e&&(e.disabled=this._dayOffset>=0);let o=this.shadowRoot.getElementById("chart-area"),s=this.shadowRoot.getElementById("records-list"),i=this.shadowRoot.getElementById("usage-body");if(!o||this._loadingChart)return;let n=this._config,r=(this._chartVisits||[]).filter(l=>l.cat).sort((l,f)=>l.ts-f.ts),c=rt,h=ct,d=lt,m=Math.max(60,...r.map(l=>l.duration)),u=j(m),p=Math.ceil(m/u)*u,{start:g}=A(this._dayOffset),{xFor:D,yFor:dt}=K({dayStart:g,niceMax:p,width:c,height:h,padding:d}),{vertical:B,horizontal:F}=q({niceMax:p,yStep:u,width:c,height:h,padding:d}),ht=B.map(l=>`<line x1="${l.x}" y1="${d.top}" x2="${l.x}" y2="${h-d.bottom}" class="grid-line-v" />`).join(""),ut=F.map(l=>`<line x1="${d.left}" y1="${l.y}" x2="${c-d.right}" y2="${l.y}" class="grid-line-h" />`).join(""),pt=(h-d.bottom)/h*100,mt=B.map(l=>`<div class="axis-label" style="left:${l.x/c*100}%;top:${pt}%">${l.label}</div>`).join(""),ft=d.left/c*100,_t=F.map(l=>`<div class="axis-label-y" style="top:${l.y/h*100}%;width:${ft}%">${l.label}</div>`).join(""),gt=r.map((l,f)=>{let v=D(l.ts),y=dt(l.duration),x=h-d.bottom;return`<line x1="${v}" y1="${x}" x2="${v}" y2="${y}" stroke="${l.cat.color}" stroke-width="2" />
    ...
    `;let E=this.shadowRoot.getElementById("chart-tooltip"),vt=o.querySelector(".chart-wrap");if(o.querySelectorAll(".visit-hit").forEach(l=>{l.addEventListener("mouseenter",()=>{let f=r[parseInt(l.dataset.idx,10)],v=new Date(f.ts).toLocaleTimeString(void 0,{hour:"2-digit",minute:"2-digit"});E.textContent=`${v} \xB7 ${f.cat.name} \xB7 ${C(f.duration)}`;let y=l.getBoundingClientRect(),x=vt.getBoundingClientRect();E.style.left=`${y.left-x.left+y.width/2}px`,E.style.top=`${y.top-x.top}px`,E.classList.add("visible")}),l.addEventListener("mouseleave",()=>{E.classList.remove("visible")})}),i){let l={};n.cats.forEach(b=>{l[b.name]={count:0}});let f=0,v=H;r.forEach(b=>{b.cat.name===w?(f+=1,v=b.cat.color):l[b.cat.name].count+=1});let y=r.length,x=n.cats.map(b=>{let wt=l[b.name];return`<span class="usage-cat"><span class="dot" style="background:${b.color}"></span>${b.name}: ${wt.count}</span>`}).join("")+(f>0?`<span class="usage-cat"><span class="dot" style="background:${v}"></span>${w}: ${f}</span>`:"");i.innerHTML=`
      ...
      `}let yt=this._chartEventHist||[],bt=this._eventLabels(),xt=(n.event_exclude||ot).map(l=>String(l).toLowerCase()),$=yt.map(l=>{let f=l.s??l.state,v=l.lu?l.lu*1e3:l.last_changed?Date.parse(l.last_changed):null;return!f||!v||xt.includes(f.toLowerCase())?null:{ts:v,icon:"mdi:information-outline",color:"var(--secondary-text-color)",text:bt[f]||f}}).filter(Boolean);$.sort((l,f)=>f.ts-l.ts),s&&($.length===0?s.innerHTML='<div class="empty-note">No records for this day</div>':s.innerHTML=$.map(l=>`
        ...
        `).join(""))}_eventLabels(){return{...et,...this._config.event_labels||{}}}_renderAnalyticsArea(){if(!this._built)return;let t=this.shadowRoot.getElementById("analytics-grid"),e=this.shadowRoot.getElementById("decline-banner"),o=this.shadowRoot.getElementById("no-visit-banner");if(!t||this._loadingAnalytics||!this._analytics)return;let s=this._config,i=(s.decline_threshold_pct||it)/100,n=[];if(t.innerHTML=s.cats.map(r=>{let c=this._analytics[r.name]||{};return c.daysOfHistory>=3&&c.avg7dTotal&&new Date().getHours()>=18&&(c.todayTotal<i*c.avg7dTotal?n.push(`${r.name}'s usage today is well below their recent average \u2014 worth a check.`):c.todayTotal>(2-i)*c.avg7dTotal&&n.push(`${r.name}'s usage today is well above their recent average \u2014 worth a check.`)),`
    ...
    `,this._renderMainForm(),this._renderCats(),this._renderInfoRows(),this._renderControlsRows(),this._restorePanelExpanded(t),this._lastStructureKey=this._structureKey(this._config),this.shadowRoot.getElementById("add-cat").addEventListener("click",()=>this._addCat()),this.shadowRoot.getElementById("add-info-row").addEventListener("click",()=>this._addInfoRow()),this.shadowRoot.getElementById("add-control-row").addEventListener("click",()=>this._addControlRow())}_removeIconButton(t){let e=document.createElement("ha-icon-button");e.className="remove-btn",e.label="Remove";let o=document.createElement("ha-icon");return o.setAttribute("icon","mdi:delete-outline"),e.appendChild(o),e.addEventListener("click",t),e}_renderCats(){let t=this.shadowRoot.getElementById("cats-rows");t.innerHTML="",(this._config.cats||[]).forEach((o,s)=>{let i=document.createElement("div");i.className="row",i.dataset.index=String(s);let n=document.createElement("ha-form");n.schema=Tt,n.data=o,n.hass=this._hass,n.computeLabel=r=>r.label||r.name,n.addEventListener("value-changed",r=>{r.stopPropagation(),this._updateCat(s,r.detail.value)}),this._formEls.push(n),this._catForms.push(n),i.appendChild(n),i.appendChild(this._removeIconButton(()=>this._removeCat(s))),t.appendChild(i)})}_updateCat(t,e){let o=[...this._config.cats||[]];o[t]=e,this._fireConfigChanged({...this._config,cats:o})}_addCat(){let t=[...this._config.cats||[],{...Lt}];this._fireConfigChanged({...this._config,cats:t}),this._render()}_removeCat(t){let e=(this._config.cats||[]).filter((o,s)=>s!==t);this._fireConfigChanged({...this._config,cats:e}),this._render()}_renderInfoRows(){let t=this.shadowRoot.getElementById("info-rows");t.innerHTML="",(this._config.info_row||[]).forEach((o,s)=>{let i=document.createElement("div");i.className="row",i.dataset.index=String(s);let n=document.createElement("ha-form");n.schema=St,n.data=o,n.hass=this._hass,n.computeLabel=r=>r.label||r.name,n.addEventListener("value-changed",r=>{r.stopPropagation(),this._updateInfoRow(s,r.detail.value)}),this._formEls.push(n),this._infoForms.push(n),i.appendChild(n),i.appendChild(this._removeIconButton(()=>this._removeInfoRow(s))),t.appendChild(i)})}_updateInfoRow(t,e){let o=[...this._config.info_row||[]];o[t]=e,this._fireConfigChanged({...this._config,info_row:o})}_addInfoRow(){let t=[...this._config.info_row||[],{...Rt}];this._fireConfigChanged({...this._config,info_row:t}),this._render()}_removeInfoRow(t){let e=(this._config.info_row||[]).filter((o,s)=>s!==t);this._fireConfigChanged({...this._config,info_row:e}),this._render()}_renderControlsRows(){let t=this.shadowRoot.getElementById("controls-rows");t.innerHTML="",this._controlForms=[],(this._config.controls_row||[]).forEach((o,s)=>{let i=document.createElement("div");i.className="row",i.dataset.index=String(s);let n=document.createElement("ha-form");n.schema=It(o.action),n.data=o,n.hass=this._hass,n.computeLabel=r=>r.label||r.name,n.addEventListener("value-changed",r=>{r.stopPropagation(),this._updateControlRow(s,r.detail.value)}),this._formEls.push(n),this._controlForms.push(n),i.appendChild(n),i.appendChild(this._removeIconButton(()=>this._removeControlRow(s))),t.appendChild(i)})}_updateControlRow(t,e){let o=[...this._config.controls_row||[]],s=o[t]&&o[t].action;o[t]=e,this._fireConfigChanged({...this._config,controls_row:o}),e.action!==s&&(this._renderControlsRows(),this._lastStructureKey=this._structureKey(this._config))}_addControlRow(){let t=[...this._config.controls_row||[],{...Ht}];this._fireConfigChanged({...this._config,controls_row:t}),this._render()}_removeControlRow(t){let e=(this._config.controls_row||[]).filter((o,s)=>s!==t);this._fireConfigChanged({...this._config,controls_row:e}),this._render()}_renderMainForm(){let t=this.shadowRoot.getElementById("main-section"),e=document.createElement("ha-form");e.schema=Ot,e.data=this._config,e.hass=this._hass,e.computeLabel=o=>o.label||o.name,e.addEventListener("value-changed",o=>{o.stopPropagation(),this._fireConfigChanged(o.detail.value)}),this._formEls.push(e),this._mainForm=e,t.appendChild(e)}};customElements.get("petkit-puramax-card")||customElements.define("petkit-puramax-card",S);customElements.get("petkit-puramax-card-editor")||customElements.define("petkit-puramax-card-editor",R);var O=window;O.customCards=O.customCards||[];O.customCards.push({type:"petkit-puramax-card",name:"PETKIT PURAMAX Card",description:"Configurable card for PETKIT PURAMAX litter box monitoring, controls, and per-cat visit analytics."});
