function x(o){let t=Math.round(o||0);if(t<60)return`${t}s`;let e=Math.floor(t/60),i=t%60;return`${e}m${i.toString().padStart(2,"0")}s`}function B(o){let t=Math.round(o||0),e=Math.floor(t/60),i=t%60;return`${e.toString().padStart(2,"0")}'${i.toString().padStart(2,"0")}"`}function O(o){let t=Math.floor(o);return t<1?"under 1h":t<48?`${t}h`:`${Math.floor(t/24)}d`}function y(o){return String(o).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function A(o,t=new Date){let e=new Date(t.getFullYear(),t.getMonth(),t.getDate());e.setDate(e.getDate()+o);let i=new Date(e);return i.setDate(i.getDate()+1),{start:e,end:i}}function V(o,t=new Date){if(o===0)return"Today";if(o===-1)return"Yesterday";let{start:e}=A(o,t);return e.toLocaleDateString(void 0,{weekday:"short",month:"short",day:"numeric"})}function I(o){let t=new Date(o);return`${t.getFullYear()}-${t.getMonth()}-${t.getDate()}`}function T({startTime:o,endTime:t,entityIds:e,includeStartTimeState:i=!1}){let n=o instanceof Date?o.toISOString():o,s=t instanceof Date?t.toISOString():t;return{type:"history/history_during_period",start_time:n,end_time:s,entity_ids:e,minimal_response:!1,no_attributes:!0,include_start_time_state:i}}function vt(o){if(!o)return null;let t=o.s??o.state,e=parseFloat(t),i=o.lu?o.lu*1e3:o.last_changed?Date.parse(o.last_changed):null;return!Number.isFinite(e)||!i||Number.isNaN(i)?null:{value:e,ts:i}}function z(o,{minDelta:t=0,maxDelta:e=1/0}={}){if(!Array.isArray(o))return[];let i=o.map(vt).filter(Boolean).sort((s,a)=>s.ts-a.ts),n=[];for(let s=1;s<i.length;s++){let a=i[s].value-i[s-1].value;a>t&&a<e&&n.push({value:a,ts:i[s].ts})}return n}function F(o,t){if(!Array.isArray(o))return[];let e=new Set(t),i=[];for(let n of o){let s=n.s??n.state;if(!e.has(s))continue;let a=n.lu?n.lu*1e3:n.last_changed?Date.parse(n.last_changed):null;!a||Number.isNaN(a)||i.push({cat:s,ts:a})}return i.sort((n,s)=>n.ts-s.ts),i}var U=15e3;function P(o,t,{toleranceMs:e=U}={}){let i=0,n=null;return o.map(s=>{for(;i<t.length&&t[i].ts<=s.ts+e;)n=t[i].cat,i++;return{...s,cat:n}})}var yt=U;function W({ts:o,rawState:t,visits:e,cats:i,toleranceMs:n=yt}){let s=i.find(a=>t===`${a.name} used the litter box`);return s?e.some(a=>a.cat.name===s.name&&Math.abs(a.ts-o)<=n):!1}var bt=[10,15,30,60,120,180,300,600,900,1800,3600];function j(o){for(let t of bt)if(o/t<=5)return t;return Math.ceil(o/5/60)*60}function q({dayStart:o,niceMax:t,width:e,height:i,padding:n}){let{left:s,right:a,top:r,bottom:c}=n,u=e-s-a,h=i-r-c,d=o.getTime();return{xFor:v=>{let L=(v-d)/36e5;return s+L/24*u},yFor:v=>t?i-c-v/t*h:i-c}}function G({niceMax:o,yStep:t,width:e,height:i,padding:n}){let{left:s,right:a,top:r,bottom:c}=n,u=e-s-a,h=i-r-c,d=[4,8,12,16,20].map(p=>({hour:p,x:s+p/24*u,label:`${p.toString().padStart(2,"0")}:00`})),f=[];if(t>0)for(let p=0;p<=o;p+=t){let v=o?i-c-p/o*h:i-c;f.push({value:p,y:v,label:B(p)})}return{vertical:d,horizontal:f}}function K(o,{dayKeyFn:t}){let e={};for(let i of o||[]){let n=t(i.ts);e[n]||(e[n]={count:0,total:0}),e[n].count+=1,e[n].total+=i.value}return e}function X(o,t){let e=Object.keys(o).filter(h=>h!==t).sort(),i=e.slice(-3),n=e.slice(-7),s=(h,d)=>h.length?h.reduce((f,p)=>f+o[p][d],0)/h.length:null,a=h=>{if(!h.length)return null;let d=h.reduce((p,v)=>p+o[v].total,0),f=h.reduce((p,v)=>p+o[v].count,0);return f>0?d/f:null},r=o[t],c=r?r.count:0,u=r?r.total:0;return{todayCount:c,todayTotal:u,todayAvgDuration:c>0?u/c:null,avg3dVisits:s(i,"count"),avg3dTotal:s(i,"total"),avg3dDuration:a(i),avg7dVisits:s(n,"count"),avg7dTotal:s(n,"total"),avg7dDuration:a(n),daysOfHistory:e.length}}function Y({lastVisitTs:o,now:t,thresholdHours:e}){let i=t instanceof Date?t.getTime():t;if(o==null)return{alerting:!0,hoursSince:null};let n=(i-o)/36e5;return{alerting:n>=e,hoursSince:n}}function J(o,t){let e=t;o.value_map&&t in o.value_map?e=o.value_map[t]:t!==null&&o.unit&&(e=`${t}${o.unit}`),e==null&&(e="\u2014");let i=parseFloat(t),n=!1;return o.warn_below!==void 0&&Number.isFinite(i)&&(n=i<o.warn_below),o.warn_above!==void 0&&Number.isFinite(i)&&(n=n||i>o.warn_above),o.warn_state!==void 0&&(n=n||t===o.warn_state),{display:e,warn:n}}function Q(o,t,e){return!t||!o||!o.states||!o.states[t]?e:o.states[t].state}function Z(o,t){let e=new CustomEvent("hass-more-info",{bubbles:!0,composed:!0,detail:{entityId:t}});o.dispatchEvent(e)}function R(o,t,e,i){o.callService(t,e,i)}function E(o,t){t&&R(o,"button","press",{entity_id:t})}var tt=`
...
`;var et={maintenance_mode:"Maintenance mode",manual_odor_completed:"Manual odor removal done",auto_cleaning_completed:"Auto cleaning done",no_events_yet:null,unavailable:null,unknown:null},it="PETKIT PURAMAX",nt=60,ot=8,st=1800,at=600,rt=240,ct={left:46,right:10,top:10,bottom:28};var $=class extends HTMLElement{static getConfigElement(){return document.createElement("petkit-puramax-card-editor")}static getStubConfig(){return{type:"custom:petkit-puramax-card",title:"PETKIT PURAMAX",device_entities:{error:"sensor.example_petkit_error",last_event:"sensor.example_petkit_last_event",state:"sensor.example_petkit_state",total_use:"sensor.example_petkit_total_use"},cats:[{name:"Example Cat",color:"#4fc3f7"}]}}setConfig(t){if(!t)throw new Error("petkit-puramax-card: config is required");if(!t.device_entities)throw new Error('petkit-puramax-card: "device_entities" is required in config');if(!t.device_entities.total_use)throw new Error('petkit-puramax-card: "device_entities.total_use" is required in config');if(!t.cats)throw new Error('petkit-puramax-card: "cats" is required in config');if(!Array.isArray(t.cats)||t.cats.length<1)throw new Error('petkit-puramax-card: "cats" must be a non-empty array');if(t.cats.length>1&&!t.device_entities.last_used_by)throw new Error('petkit-puramax-card: "device_entities.last_used_by" is required in config when more than one cat is configured');t.cats.forEach((e,i)=>{if(!e||!e.name)throw new Error(`petkit-puramax-card: cats[${i}].name is required`);if(!e.color)throw new Error(`petkit-puramax-card: cats[${i}].color is required`)}),this._config=t,this._dayOffset=0,this._analytics=null,this._chartData=null,this._loadingChart=!1,this._loadingAnalytics=!1,this.shadowRoot||this.attachShadow({mode:"open"}),this._render()}set hass(t){let e=this._hass;if(this._hass=t,!this._built){this._built=!0,this._render(),this._loadDay(),this._loadAnalytics(),this._startNoVisitTimer();return}this._updateLiveValues(),this._maybeRefreshOnNewVisit(e)}get hass(){return this._hass}getCardSize(){return 14}connectedCallback(){this._hass&&!this._built&&(this._built=!0,this._render(),this._loadDay(),this._loadAnalytics(),this._startNoVisitTimer())}disconnectedCallback(){this._noVisitTimer&&(clearInterval(this._noVisitTimer),this._noVisitTimer=null)}_startNoVisitTimer(){this._noVisitTimer||(this._noVisitTimer=setInterval(()=>this._checkNoVisitAlerts(),300*1e3))}_maybeRefreshOnNewVisit(t){if(!t)return;let e=this._config.device_entities.total_use,i=t.states[e],n=this._hass.states[e];n&&(!i||i.last_changed!==n.last_changed)&&(this._dayOffset===0&&this._loadDay(),this._loadAnalytics())}_s(t,e){return Q(this._hass,t,e)}async _fetchVisits({start:t,end:e}){let i=this._config,n=T({startTime:t,endTime:e,entityIds:[i.device_entities.total_use]}),s=[this._hass.callWS(n)];if(i.cats.length>1){let d=T({startTime:t,endTime:e,entityIds:[i.device_entities.last_used_by],includeStartTimeState:!0});s.push(this._hass.callWS(d))}let a={},r={};try{let[d,f]=await Promise.all(s);a=d||{},r=f||{}}catch{}let c=z(a[i.device_entities.total_use],{minDelta:0,maxDelta:st}),u;if(i.cats.length>1){let d=i.cats.map(p=>p.name),f=F(r[i.device_entities.last_used_by],d);u=P(c,f)}else u=c.map(d=>({...d,cat:i.cats[0].name}));let h=new Map(i.cats.map(d=>[d.name,d]));return u.filter(d=>h.has(d.cat)).map(d=>({cat:h.get(d.cat),duration:d.value,ts:d.ts}))}async _loadDay(){if(!this._hass)return;this._loadingChart=!0,this._renderChartArea();let t=this._config,{start:e,end:i}=A(this._dayOffset),n=[],s=[];try{let[a,r]=await Promise.all([this._fetchVisits({start:e,end:i}),t.device_entities.last_event?this._hass.callWS(T({startTime:e,endTime:i,entityIds:[t.device_entities.last_event]})):Promise.resolve({})]);n=a,s=(r||{})[t.device_entities.last_event]||[]}catch{n=[],s=[]}this._chartVisits=n,this._chartEventHist=s,this._loadingChart=!1,this._renderChartArea()}async _loadAnalytics(){if(!this._hass)return;this._loadingAnalytics=!0,this._renderAnalyticsArea();let t=this._config,e=new Date,i=new Date(e.getTime()-168*3600*1e3),n=[];try{n=await this._fetchVisits({start:i,end:e})}catch{n=[]}let s=I(e.getTime()),a={};t.cats.forEach(r=>{let c=n.filter(d=>d.cat===r).map(d=>({value:d.duration,ts:d.ts})),u=K(c,{dayKeyFn:I}),h=c.length?Math.max(...c.map(d=>d.ts)):null;a[r.name]={...X(u,s),lastVisitTs:h}}),this._analytics=a,this._loadingAnalytics=!1,this._checkNoVisitAlerts(),this._renderAnalyticsArea()}_checkNoVisitAlerts(){if(!this._analytics||!this._built)return;let t=this._config,e=t.no_visit_alert_hours??ot,i=Date.now();this._notifiedCats||(this._notifiedCats=new Set),t.cats.forEach(n=>{let s=this._analytics[n.name];if(!s)return;let a=Y({lastVisitTs:s.lastVisitTs,now:i,thresholdHours:e});s.noVisitAlert=a;let r=this._notifiedCats.has(n.name);a.alerting&&!r?(this._notifiedCats.add(n.name),this._sendNoVisitNotification(n,a)):!a.alerting&&r&&this._notifiedCats.delete(n.name)}),this._renderAnalyticsArea()}_sendNoVisitNotification(t,e){let i=this._config.notify_service;if(!i||!this._hass)return;let n=i.indexOf(".");if(n===-1)return;let s=i.slice(0,n),a=i.slice(n+1);if(s!=="notify"||!a)return;let r=e.hoursSince==null?`${t.name} hasn't used the litter box yet in the tracked history.`:`${t.name} hasn't used the litter box in over ${Math.floor(e.hoursSince)}h.`;R(this._hass,"notify",a,{message:r,title:"Litter box alert"})}_render(){let t=this._config;this.shadowRoot.innerHTML=`
    ...
    `,this.shadowRoot.getElementById("prev-day").addEventListener("click",()=>this._changeDay(-1)),this.shadowRoot.getElementById("next-day").addEventListener("click",()=>this._changeDay(1)),this._updateLiveValues(),this._renderChartArea(),this._renderAnalyticsArea()}_changeDay(t){this._dayOffset+=t,this._dayOffset>0&&(this._dayOffset=0),this._loadDay()}_updateLiveValues(){if(!this._built)return;let t=this._config,e=t.device_entities,i=this.shadowRoot.getElementById("status-row");if(i){let s=this._s(e.error,"no_error"),a=s&&s!=="no_error",r=t.info_row||[];i.innerHTML=[...r.map(c=>this._renderInfoChip(c)),a?this._chip("mdi:alert","Error",s.replace(/_/g," "),!0):""].join("")}let n=this.shadowRoot.getElementById("controls-row");if(n&&!n.dataset.bound){let s=t.controls_row||[];n.innerHTML=s.map((a,r)=>`
      ...
      `).join(""),n.dataset.bound="1",s.forEach((a,r)=>{this.shadowRoot.getElementById(`ctrl-${r}`).addEventListener("click",()=>this._runControlAction(a))})}}_renderInfoChip(t){let e=this._s(t.entity,null),{display:i,warn:n}=J(t,e);return this._chip(t.icon||"mdi:information-outline",t.name||t.entity,i,n)}_runControlAction(t){switch(t.action){case"press":{t.confirm?window.confirm(t.confirm)&&E(this._hass,t.entity):E(this._hass,t.entity);break}case"toggle_maintenance":{let e=t.state_entity||this._config.device_entities.state;this._s(e,"")==="maintenance"?E(this._hass,t.exit_entity):E(this._hass,t.start_entity);break}case"toggle":{R(this._hass,"homeassistant","toggle",{entity_id:t.entity});break}case"more_info":{Z(this,t.entity);break}default:break}}_chip(t,e,i,n){return`
      ...
      </div>`}_renderChartArea(){if(!this._built)return;let t=this.shadowRoot.getElementById("day-label");t&&(t.textContent=V(this._dayOffset));let e=this.shadowRoot.getElementById("next-day");e&&(e.disabled=this._dayOffset>=0);let i=this.shadowRoot.getElementById("chart-area"),n=this.shadowRoot.getElementById("records-list"),s=this.shadowRoot.getElementById("usage-body");if(!i||this._loadingChart)return;let a=this._config,r=(this._chartVisits||[]).slice().sort((l,_)=>l.ts-_.ts),c=at,u=rt,h=ct,d=Math.max(60,...r.map(l=>l.duration)),f=j(d),p=Math.ceil(d/f)*f,{start:v}=A(this._dayOffset),{xFor:L,yFor:lt}=q({dayStart:v,niceMax:p,width:c,height:u,padding:h}),{vertical:N,horizontal:H}=G({niceMax:p,yStep:f,width:c,height:u,padding:h}),dt=N.map(l=>`<line x1="${l.x}" y1="${h.top}" x2="${l.x}" y2="${u-h.bottom}" class="grid-line-v" />`).join(""),ht=H.map(l=>`<line x1="${h.left}" y1="${l.y}" x2="${c-h.right}" y2="${l.y}" class="grid-line-h" />`).join(""),ut=(u-h.bottom)/u*100,pt=N.map(l=>`<div class="axis-label" style="left:${l.x/c*100}%;top:${ut}%">${l.label}</div>`).join(""),_t=H.map(l=>`<div class="axis-label-y" style="top:${l.y/u*100}%">${l.label}</div>`).join(""),mt=r.map((l,_)=>{let g=L(l.ts),m=lt(l.duration),b=u-h.bottom;return`<line x1="${g}" y1="${b}" x2="${g}" y2="${m}" stroke="${l.cat.color}" stroke-width="2" />
    ...
    `;let w=this.shadowRoot.getElementById("chart-tooltip"),ft=i.querySelector(".chart-wrap");if(i.querySelectorAll(".visit-hit").forEach(l=>{l.addEventListener("mouseenter",()=>{let _=r[parseInt(l.dataset.idx,10)],g=new Date(_.ts).toLocaleTimeString(void 0,{hour:"2-digit",minute:"2-digit"});w.textContent=`${g} \xB7 ${_.cat.name} \xB7 ${x(_.duration)}`;let m=l.getBoundingClientRect(),b=ft.getBoundingClientRect();w.style.left=`${m.left-b.left+m.width/2}px`,w.style.top=`${m.top-b.top}px`,w.classList.add("visible")}),l.addEventListener("mouseleave",()=>{w.classList.remove("visible")})}),s){let l={};a.cats.forEach(m=>{l[m.name]={count:0}}),r.forEach(m=>{l[m.cat.name].count+=1});let _=r.length,g=a.cats.map(m=>{let b=l[m.name];return`<span class="usage-cat"><span class="dot" style="background:${m.color}"></span>${m.name}: ${b.count}</span>`}).join("");s.innerHTML=`
        <div class="usage-row">
          <div class="stat-value">${_} time${_===1?"":"s"}</div>
          <div class="usage-cats">${g}</div>
        </div>
      `}let C=r.map(l=>({ts:l.ts,icon:"mdi:cat",color:l.cat.color,text:`${l.cat.name} just spent ${x(l.duration)} in the litter box`})),gt=this._chartEventHist||[],D=this._eventLabels(),M=null;gt.forEach(l=>{let _=l.s??l.state,g=l.lu?l.lu*1e3:l.last_changed?Date.parse(l.last_changed):null;if(!_||!g||_ in D&&D[_]===null||W({ts:g,rawState:_,visits:r,cats:a.cats})||_===M)return;M=_;let m=D[_]||_.replace(/_/g," ").replace(/\b\w/g,b=>b.toUpperCase());C.push({ts:g,icon:"mdi:information-outline",color:"var(--secondary-text-color)",text:m})}),C.sort((l,_)=>_.ts-l.ts),n&&(C.length===0?n.innerHTML='<div class="empty-note">No records for this day</div>':n.innerHTML=C.map(l=>`
        ...
        `).join(""))}_eventLabels(){return{...et,...this._config.event_labels||{}}}_renderAnalyticsArea(){if(!this._built)return;let t=this.shadowRoot.getElementById("analytics-grid"),e=this.shadowRoot.getElementById("decline-banner"),i=this.shadowRoot.getElementById("no-visit-banner");if(!t||this._loadingAnalytics||!this._analytics)return;let n=this._config,s=(n.decline_threshold_pct||nt)/100,a=[];if(t.innerHTML=n.cats.map(r=>{let c=this._analytics[r.name]||{};return c.daysOfHistory>=3&&c.avg7dTotal&&new Date().getHours()>=18&&(c.todayTotal<s*c.avg7dTotal?a.push(`${r.name}'s usage today is well below their recent average \u2014 worth a check.`):c.todayTotal>(2-s)*c.avg7dTotal&&a.push(`${r.name}'s usage today is well above their recent average \u2014 worth a check.`)),`
    ...
    `,this._renderMainForm(),this._renderCats(),this._renderInfoRows(),this._renderControlsRows(),this.shadowRoot.getElementById("add-cat").addEventListener("click",()=>this._addCat()),this.shadowRoot.getElementById("add-info-row").addEventListener("click",()=>this._addInfoRow()),this.shadowRoot.getElementById("add-control-row").addEventListener("click",()=>this._addControlRow())}_removeIconButton(t){let e=document.createElement("ha-icon-button");e.className="remove-btn",e.label="Remove";let i=document.createElement("ha-icon");return i.setAttribute("icon","mdi:delete-outline"),e.appendChild(i),e.addEventListener("click",t),e}_renderCats(){let t=this.shadowRoot.getElementById("cats-rows");t.innerHTML="",(this._config.cats||[]).forEach((i,n)=>{let s=document.createElement("div");s.className="row",s.dataset.index=String(n);let a=document.createElement("ha-form");a.schema=xt,a.data=i,a.hass=this._hass,a.computeLabel=r=>r.label||r.name,a.addEventListener("value-changed",r=>{r.stopPropagation(),this._updateCat(n,r.detail.value)}),this._formEls.push(a),s.appendChild(a),s.appendChild(this._removeIconButton(()=>this._removeCat(n))),t.appendChild(s)})}_updateCat(t,e){let i=[...this._config.cats||[]];i[t]=e,this._fireConfigChanged({...this._config,cats:i})}_addCat(){let t=[...this._config.cats||[],{...wt}];this._fireConfigChanged({...this._config,cats:t}),this._render()}_removeCat(t){let e=(this._config.cats||[]).filter((i,n)=>n!==t);this._fireConfigChanged({...this._config,cats:e}),this._render()}_renderInfoRows(){let t=this.shadowRoot.getElementById("info-rows");t.innerHTML="",(this._config.info_row||[]).forEach((i,n)=>{let s=document.createElement("div");s.className="row",s.dataset.index=String(n);let a=document.createElement("ha-form");a.schema=Et,a.data=i,a.hass=this._hass,a.computeLabel=r=>r.label||r.name,a.addEventListener("value-changed",r=>{r.stopPropagation(),this._updateInfoRow(n,r.detail.value)}),this._formEls.push(a),s.appendChild(a),s.appendChild(this._removeIconButton(()=>this._removeInfoRow(n))),t.appendChild(s)})}_updateInfoRow(t,e){let i=[...this._config.info_row||[]];i[t]=e,this._fireConfigChanged({...this._config,info_row:i})}_addInfoRow(){let t=[...this._config.info_row||[],{...Ct}];this._fireConfigChanged({...this._config,info_row:t}),this._render()}_removeInfoRow(t){let e=(this._config.info_row||[]).filter((i,n)=>n!==t);this._fireConfigChanged({...this._config,info_row:e}),this._render()}_renderControlsRows(){let t=this.shadowRoot.getElementById("controls-rows");t.innerHTML="",(this._config.controls_row||[]).forEach((i,n)=>{let s=document.createElement("div");s.className="row",s.dataset.index=String(n);let a=document.createElement("ha-form");a.schema=$t(i.action),a.data=i,a.hass=this._hass,a.computeLabel=r=>r.label||r.name,a.addEventListener("value-changed",r=>{r.stopPropagation(),this._updateControlRow(n,r.detail.value)}),this._formEls.push(a),s.appendChild(a),s.appendChild(this._removeIconButton(()=>this._removeControlRow(n))),t.appendChild(s)})}_updateControlRow(t,e){let i=[...this._config.controls_row||[]],n=i[t]&&i[t].action;i[t]=e,this._fireConfigChanged({...this._config,controls_row:i}),e.action!==n&&this._renderControlsRows()}_addControlRow(){let t=[...this._config.controls_row||[],{...St}];this._fireConfigChanged({...this._config,controls_row:t}),this._render()}_removeControlRow(t){let e=(this._config.controls_row||[]).filter((i,n)=>n!==t);this._fireConfigChanged({...this._config,controls_row:e}),this._render()}_renderMainForm(){let t=this.shadowRoot.getElementById("main-section"),e=document.createElement("ha-form");e.schema=Lt,e.data=this._flattenMain(),e.hass=this._hass,e.computeLabel=i=>i.label||i.name,e.addEventListener("value-changed",i=>{i.stopPropagation(),this._onMainFormChanged(i.detail.value)}),this._formEls.push(e),t.appendChild(e)}};customElements.get("petkit-puramax-card")||customElements.define("petkit-puramax-card",$);customElements.get("petkit-puramax-card-editor")||customElements.define("petkit-puramax-card-editor",S);var k=window;k.customCards=k.customCards||[];k.customCards.push({type:"petkit-puramax-card",name:"PETKIT PURAMAX Card",description:"Configurable card for PETKIT PURAMAX litter box monitoring, controls, and per-cat visit analytics."});
